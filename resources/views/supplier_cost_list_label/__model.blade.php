            ...
            <div class="modal-body">
                <form id="supplierCostListLabelForm" name="supplierCostListLabelForm" class="form-horizontal">
                    ...
                    <div class="form-group mb-2 p-1">
                        <label for="cost_level" class="form-label pb-1">Cost Level <sup style="color:red; font-size: 0.9rem;"><strong>*</strong></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group mb-2 p-1">
                        <label for="cost_code" class="form-label pb-1">Cost Code</label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group mb-2 p-1">
                        <label for="cost_label" class="form-label pb-1">Cost Label <sup style="color:red; font-size: 0.9rem;"><strong>*</strong></label>
                        <div class="col-sm-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="showSupplierCostListLabelForm" name="showSupplierCostListLabelForm" class="form-horizontal">
                    <div class="form-group mb-2 p-1">
                        <label for="cost_level" class="form-label pb-1">Cost Level</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" disabled id="cost_level" name="cost_level"  value="">
                        </div>
                        <span class="text-danger error-text cost_level_error"></span>
                    </div>
                    <div class="form-group mb-2 p-1">
                        <label for="cost_code" class="form-label pb-1">Cost Code</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" disabled id="cost_code" name="cost_code" value="">
                        </div>
                        <span class="text-danger error-text cost_code_error"></span>
                    </div>
                    <div class="form-group mb-2 p-1">
                        <label for="cost_label" class="form-label pb-1">Cost Label</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" disabled id="cost_label" name="cost_label"  value="">
                        </div>
                        <span class="text-danger error-text cost_label_error"></span>
                    </div>
                </form>
