...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4 text-dark"><span class="text-primary">Edit Quote for Opportunity # {{$opportunity->opportunity_code??''}}</span> {{$customer->customer_name??''}}@ {{$company->company_name??''}}</h4>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="quote_label" id="quote_label" value="{{$quote->quote_label}}" placeholder="Enter Quote Label">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="date" class="form-control" name="quote_date" id="quote_date" value="{{$quote->quote_date}}">
                                        <span class="text-danger error-text quote_date_error"></span>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <label class="form-label" for="quote_time">Quote Time</label>
                                        <input type="time" class="form-control" name="quote_time" id="quote_time" value="{{$quote->quote_time}}">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" name="expiry_date" id="expiry_date" value="{{$quote->expiry_date}}">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="customer_po" id="customer_po" placeholder="Enter Customer P.O" value="{{$quote->customer_po}}">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" id="eta_date" name="eta_date" aria-label="Address" value="{{$quote->eta_date}}" />
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select class="select2 form-select" id="quote_header_id" name="quote_header_id">
                                            ...
                                            <option value="{{ $id }}" {{ isset($quote) && $quote->quote_header_id == $id ? 'selected' : '' }}>{{ $quote_header_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select class="select2 form-select" id="quote_footer_id" name="quote_footer_id">
                                            ...
                                            <option value="{{ $id }}" {{ isset($quote) && $quote->quote_footer_id == $id ? 'selected' : '' }}>{{ $quote_footer_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-2">
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select id="quote_printed_notes_id" name="quote_printed_notes_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($quote) && $quote->quote_printed_notes_id == $id ? 'selected' : '' }}>{{ $quote_printed_notes_name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        ...
                                        <textarea class="form-control" rows="3" name="quote_printed_note" id="quote_printed_note" placeholder="Enter Printed Notes">{{$quote->quote_printed_note}}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="3 " name="quote_internal_note" id="quote_internal_note" placeholder="Enter Internal Notes">{{$quote->quote_internal_note}}</textarea>
