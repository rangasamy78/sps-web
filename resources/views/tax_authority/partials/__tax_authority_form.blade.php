    ...
    <div class="col-12 col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-3">
                        <label class="form-label" for="name">Authority Name <sup
                                style="color:red; font-size: 0.9rem;"><strong>*</strong></sup></label>
                        {!! Form::text('authority_name', null, [
                            'class' => 'form-control' . ($errors->has('authority_name') ? ' is-invalid' : ''),
                            'id' => 'authority_name',
                    ...
                    <div class="col-3">
                        <label class="form-label" for="print_name">Print Name <sup
                                style="color:red; font-size: 0.9rem;"><strong>*</strong></sup></label>
                        {!! Form::text('print_name', null, [
                            'class' => 'form-control',
                            'id' => 'print_name',
            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        {!! Form::text('secondary_phone', null, [
                            'class' => 'form-control',
                            'id' => 'secondary_phone',
