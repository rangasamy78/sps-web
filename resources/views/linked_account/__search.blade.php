<div class="card">
    <div class="row g-3 mb-3 p-3">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <select class="form-select select2" name="accountTypeFilter[]" multiple id="accountTypeFilter" >
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <select class="form-select select2" name="accountSubTypeFilter[]" multiple id="accountSubTypeFilter" >
