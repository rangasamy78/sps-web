<div class="card">
    <div class="row g-3 mb-3 p-3">
        ...
        <select class="form-control" id="inventoryGLAccountFilter" name="inventoryGLAccountFilter">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <select id="salesGLAccountFilter" class="form-select" name="salesGLAccountFilter">
            <option value="">--Select Sales GL Account--</option>
            <option value="47900-Sales">47900-Sales</option>
            </select>
        </div>
        <div class="col-12 col-sm-6 col-lg-3">
            <select id="cogsGLAccountFilter" class="form-select" name="cogsGLAccountFilter">
