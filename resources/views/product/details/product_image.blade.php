        ...
        <div class="row">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                <div class="button-wrapper">
                    ...
                    <button type="submit" class="btn btn-secondary account-image-reset mb-4" data-id='1' id="saveFile" name="saveFile">
                        <i class="bx bx-reset d-block d-sm-none"></i>
                        <span class="d-none d-sm-block">Upload Images</span>
                    </button>
                </div>
            </div>
        </div>
        <div class="row">
            <input type="text" class="form-control" hidden name="account_id" id="account_id" value="1">
        </div>
