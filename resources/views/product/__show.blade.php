                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Alternate Name"><span class="text-dark fw-bold">Alternate Name:
                                                </span> {{ $product->product_alternate_name ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Generic Name"><span class="text-dark fw-bold">Generic Name:
                                                </span>{{ $product->generic_name ?? '' }}</label>
                                        </div>
                                    </div>

                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Type / Form"><span class="text-dark fw-bold">Type / Form:
                                                </span> {{ $product->product_type->product_type ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Category / Nature"><span class="text-dark fw-bold">Category /
                                                    Nature:
                                                </span>{{ $product->product_category->product_category_name ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Sub Category"><span class="text-dark fw-bold">Sub Category:
                                                </span>
                                                {{ $product->product_sub_category->product_sub_category_name ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Group"><span class="text-dark fw-bold">Group:
                                                </span>{{ $product->product_group->product_group_name ?? '' }}</label>
                                        </div>
                                    </div>

                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Finish"><span class="text-dark fw-bold">Finish:
                                                </span>{{ $product->product_finish->finish ?? '' }}</label>
                                        </div>
                                    </div>

                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Thickness"><span class="text-dark fw-bold">Thickness: </span>
                                                {{ $product->product_thickness->product_thickness_name ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="Base Color"><span class="text-dark fw-bold">Base Color:
                                                </span>{{ $product->product_color->product_color ?? '' }}</label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3">
                                    <h5 style=" ">
                                        ...
                                        <a href="{{ route('products.price_update', $product->id) }}"
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="primary_phone"><span class="text-dark fw-bold">Homeowner Price -
                                                ...
                                                {{ $product->product_price->homeowner_price ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="secondary_phone"><span class="text-dark fw-bold">Bundle Price -
                                                    Bundle Price:</span>
                                                {{ $product->product_price->bundle_price ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="mobile"><span class="text-dark fw-bold">Special Price - Special
                                                    Price:</span>
                                                {{ $product->product_price->special_price ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Loose Slab Price Per
                                                    SQFT - Price4:</span>
                                                {{ $product->product_price->loose_slab_price ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="mobile"><span class="text-dark fw-bold">Bundle Price Per SQFT -
                                                    Price5:</span>
                                                {{ $product->product_price->bundle_price_sqft ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Special Price Per SQFT
                                                    - Price6:</span>
                                                {{ $product->product_price->special_price_per_sqft ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Owner Approval Price
                                                ...
                                                {{ $product->product_price->owner_approval_price ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Loose Slab Price Per
                                                    Slab - Price8:</span>
                                                {{ $product->product_price->loose_slab_per_slab ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Bundle Price Per Slab -
                                                    Price9:</span>
                                                {{ $product->product_price->bundle_price_per_slab ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Special Price Per Slab
                                                    - Price10:</span>
                                                {{ $product->product_price->special_price_per_slab ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Owner Approval Price
                                                ...
                                                {{ $product->product_price->owner_approval_price_per_slab ?? '' }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="website"><span class="text-dark fw-bold">Price12 -
                                                    Price12:</span> {{ $product->product_price->price12 ?? '' }}</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="primary_phone"><span class="text-dark fw-bold">Preferred
                                                    Supplier:</span>{{ $product->supplier->supplier_name ?? '' }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="secondary_phone"><span class="text-dark fw-bold">Supplier
                                                    Url:</span> </label>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="primary_phone"><span class="text-dark fw-bold">Base UOM:</span>
                                                {{ $product->unit_measure->unit_measure_name ?? '' }}</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="primary_phone"><span class="text-dark fw-bold">Available:</span>
                                            </label>
                                        </div>
                                    </div>
