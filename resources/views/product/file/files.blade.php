<div class="tab-pane" id="file" role="tabpanel">
    ...
    <form id="uploadFileForm" enctype="multipart/form-data">
        <div class="row">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                <div class="button-wrapper">
                    ...
                    <button type="submit" class="btn btn-secondary account-image-reset mb-4" data-id='{{ $product->id }}' id="saveFile" name="saveFile">
        ...
        <div class="row">
            <input type="text" class="form-control" hidden name="product_id" id="product_id" value="{{ $product->id }}">
        </div>
