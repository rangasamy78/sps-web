<script type="text/javascript">
    $(function() {
        ...
        $('#saveFile').click(function(e) {
            ...
            $.ajax({
                url: '{{ route("product_files.store") }}', // Your upload route
                type: 'POST',
                data: formData,
        ...
        $(document).on('click', '.updateFile', function(e) {
            ...
            $.ajax({
                url: "{{ route('product_files.update', ':id') }}".replace(':id', id),
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.status === 'success') {
        ...
        $('body').on('click', '.filedelete', function() {
            ...
            var url = "{{ route('product_files.destroy', ':id') }}".replace(':id', id);
            $.ajax({
                url: url,
                type: "DELETE",
                data: {
