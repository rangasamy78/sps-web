<script type="text/javascript">
    $(function() {
        ...
        $('#saveVisitProductBtn').click(function(e) {
            e.preventDefault();
            var button = $(this);
            sending(button);
            // Create a new FormData object with the form data
            var formData = new FormData($('#visitProductForm')[0]);
            // Collect product data
            $('#visitProductForm #visit_product tbody tr').each(function(index) {
                var row = $(this);
            ...
            $('#visitProductForm #visit_service tbody tr').each(function(index) {
                var row = $(this);
            ...
            var url = "{{ route('visits.save_visit_product') }}";
            $.ajax({
                url: url,
                type: "POST",
                headers: {
