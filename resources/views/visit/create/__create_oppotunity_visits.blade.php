...
@section('title', 'Add Opportunity and Visit')
...
<div class="content-wrapper">
    <!-- Content -->
    <form id="opportunityVisitForm">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><a href="{{route('opportunities.index')}}" class="text-decoration-none text-dark"><span class="text-muted fw-light">Visit /</span>
                    Add Opportunity + Visit</span>
                </a></h4>
            <div class="app-ecommerce">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-primary btn-md" id="saveOpportunityVisit" name="saveOpportunityVisit">Add Opportunity + Visit</button>
...
@include('visit.create.__script_opportunity_visits')
@endsection