                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        ...
                                        <input type="date" class="form-control" name="visit_date" id="visit_date" value="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                                        <span class="text-danger error-text visit_date_error"></span>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label">Visit Time</label>
                                        <input type="time" class="form-control" name="visit_time" id="visit_time" value="{{ \Carbon\Carbon::now()->setTimezone('Asia/Kolkata')->format('h:i') }}">
