...
@section('title', 'Edit Visit Opportunity')
...
<div class="content-wrapper">
    <!-- Content -->
    <form id="opportunityVisitEditForm">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><a href="{{route('visits.index')}}" class="text-decoration-none text-dark"><span class="text-muted fw-light">Visit /</span>
                    Update Opportunity + Visit</span>
                </a></h4>
            <div class="app-ecommerce">
                                    ...
                                    <div data-repeater-item>
                                        <div class="row mb-1">
                                            <div class="mb-2 col">
                                                ...
                                                <textarea id="special_instructions" name="special_instructions" class="form-control" placeholder="Enter Special / Delivery Instruction" style="resize:none">{{$opportunity->special_instructions}}</textarea>
                                            ...
                                            <div class="mb-2 col-12">
                                                ...
                                                <textarea id="internal_notes" name="internal_notes" class="form-control" placeholder="Enter Internal Notes" style="resize:none">{{$opportunity->internal_notes}}</textarea>
                                            ...
                                            <div class="mb-2 col-12">
                                                ...
                                                <textarea id="printed_notes" name="printed_notes" class="form-control" placeholder="Enter Printed Notes" style="resize:none">{{$opportunity->printed_notes}}</textarea>
                                                <span class="text-danger error-text printed_notes_error"></span>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <h3 class="form-label text-seconadry fw-bold mt-1">Visit Information</h3>
                                                <!-- <div class="flex-grow-1 border-top border-dark ms-2"></div> -->
                                            </div>
                                            <div class="mb-2 col-12">
                                                <label class="form-label mb-1" for="printed_notes">Visit Label</label>
                                                <input type="hidden" class="form-input form-control" id="visit_id" name="visit_id" value="{{$visit->id}}">
                                                <input type="text" class="form-input form-control" id="visit_label" name="visit_label" value="{{$visit->visit_label}}">
                                                <span class="text-danger error-text printed_notes_error"></span>
                                            </div>
                                            <div class="mb-2 col-12">
                                                <label class="form-label mb-1" for="visit_printed_notes">Printed Notes for this Visit</label>
                                                <textarea id="visit_printed_notes" name="visit_printed_notes" class="form-control" placeholder="Enter Printed Notes" style="resize:none">{{$visit->visit_printed_notes}}</textarea>
                                                <span class="text-danger error-text printed_notes_error"></span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-primary btn-md" id="updateOpportunityVisit" name="updateOpportunityVisit">Update Opportunity + Visit</button>
...
@include('visit.edit.__script_opportunity_visits')
@endsection