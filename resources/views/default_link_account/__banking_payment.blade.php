                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select id="supplier_payment_cash_account_id" class="form-select" name="supplier_payment_cash_account_id">
            ...
            <div class="row g-6 mt-3">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select id="vendor_payment_cash_account_id" class="form-select" name="vendor_payment_cash_account_id">
                                <option value="">--Select--</option>
                                @foreach($data['linkedAccounts'] as $key => $linkedAccount)
            ...
            <div class="row g-6">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select id="customer_payment_cash_account_id" class="form-select" name="customer_payment_cash_account_id">
                                <option value="">--Select--</option>
                                @foreach($data['linkedAccounts'] as $key => $linkedAccount)
            ...
            <div class="row g-6">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select id="miscellaneous_expense_id" class="form-select" name="miscellaneous_expense_id">
                                <option value="">--Select--</option>
                                @foreach($data['linkedAccounts'] as $key => $linkedAccount)
