    ...
    <div class="card-body">
        <form id="accountingForm" name="accountingForm" class="form-horizontal" method="POST">
            <div class="row g-6">
                <div class="col-md-12">
                    <div class="row">
                        <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-retained-earnings">Retained Earnings</label>
                        <div class="col-sm-9">
                            <input type="hidden" name="id" id="id" value="{{ $data['accounting']['id'] ?? '' }}">
                            <select id="retained_earning_id" class="form-select" name="retained_earning_id">
