<div class="tab-pane" id="CRMEvent" role="tabpanel">
    ...
    <table class="datatables-basic table tables-basic border-top table-striped" id="holdCrmEvent">
        ...
        <form id="addCrmEventForm" enctype="multipart/form-data">
            <div class="row">
                <div class="col">
                    ...
                    <input type="hidden" class="form-control" id="type" name="type" value="hold">
                    <input type="hidden" class="form-control" id="type_id" name="type_id" value="{{$hold->id}}">
