...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4 text-dark"><span class="text-primary">Edit Hold for Opportunity # {{$opportunity->opportunity_code}}</span> {{$customer->customer_name}}@ {{$company->company_name}}</h4>
        <div class="app-ecommerce">
            <form id="updateHoldForm">
                <div class="row">
                    <div class="col-12">
                        <div class="card  mb-4">
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <input type="text" class="form-control" id="hold_code" readonly name="hold_code" aria-label="date" value="{{$hold->hold_code}}" />
                                    ...
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <input type="date" class="form-control" id="hold_date" name="hold_date" aria-label="date" value="{{$hold->hold_date}}" />
                                        <span class="text-danger error-text hold_date_error"></span>
                                    </div>
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        <label class="form-label" for="hold_time">Time</label>
                                        <input type="time" class="form-control" id="hold_time" name="hold_time" aria-label="date" value="{{ $hold->hold_time }}" />
                                    ...
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <input type="date" class="form-control" id="expiry_date" name="expiry_date" aria-label="date" value="{{$hold->expiry_date }}" />
                                        <span class="text-danger error-text expiry_date_error"></span>
                                    </div>
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        <label class="form-label" for="customer_po">Customer P.O#</label>
                                        <input type="text" class="form-control" id="customer_po" name="customer_po" aria-label="date" value="{{$hold->customer_po}}" />
                                    ...
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <select id="project_type_id" name="project_type_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->project_type_id == $id ? 'selected' : '' }}>{{ $project_type_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-2">
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <select id="location_id" name="location_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $company->id }}" {{ isset($hold) && $hold->location_id == $company->id ? 'selected' : '' }}>{{ $company->company_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-sm-8 col-md-12 pt-sm-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-1 p-1">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="pick_ticket_restriction" id="radio1" value="Exact Slab" {{isset($hold) && $hold->pick_ticket_restriction == 'Exact Slab' ? 'checked' : ''}}>
                                                <label class="form-check-label" for="radio1">Exact Slab</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="pick_ticket_restriction" id="radio2" value="Within Lot" {{isset($hold) && $hold->pick_ticket_restriction == 'Within Lot' ? 'checked' : ''}}>
                                                <label class="form-check-label" for="radio2">Within Lot</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="pick_ticket_restriction" id="radio3" value="Within Product" {{isset($hold) && $hold->pick_ticket_restriction == 'Within Product' ? 'checked' : ''}}>
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="bill_to_attn" name="bill_to_attn" aria-label="attn" value="{{$hold->bill_to_attn}}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="bill_to_fax" name="bill_to_fax" value="{{$hold->bill_to_fax}}" aria-label="bill_to_fax" />
                                        <span class="text-danger error-text bill_to_fax_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="bill_to_mobile">Mobile</label>
                                        <input type="text" class="form-control" id="bill_to_mobile" name="bill_to_mobile" value="{{$hold->bill_to_mobile}}" aria-label="bill_to_mobile" />
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <select id="payment_term_id" name="payment_term_id" class="form-select select2" data-allow-clear="true">
                                            ...
                                            <option value="{{ $payment->id }}" {{ isset($hold) && $hold->payment_term_id == $id ? 'selected' : '' }}>{{ $payment->payment_label }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select id="price_level_label_id" name="price_level_label_id" class="form-select select2" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->price_level_label_id == $id ? 'selected' : '' }}>{{ $label}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <select id="primary_sales_person_id" name="primary_sales_person_id" class="form-select select2" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->primary_sales_person_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select id="secondary_sales_person_id" name="secondary_sales_person_id" class="select2 form-select" data-allow-clear="true">
                                            <option value="">--select--</option>
                                            @foreach($data['users'] as $id => $name)
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->secondary_sales_person_id == $id ? 'selected' : '' }}>{{ $name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <select id="sales_tax_id" name="sales_tax_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->sales_tax_id == $id ? 'selected' : '' }}>{{ $tax_name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div data-repeater-item>
                                        <div class="row mb-1">
                                            <div class="mb-3 col">
                                                ...
                                                <textarea id="instructions" name="instructions" class="form-control" rows="3" placeholder="Enter Special / Delivery Instruction" style="resize:none">{{$hold->instructions}}</textarea>
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <textarea id="internal_notes" name="internal_notes" class="form-control" rows="3" placeholder="Enter Internal Notes" style="resize:none">{{$hold->internal_notes}}</textarea>
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <textarea id="printed_notes" name="printed_notes" class="form-control" rows="3" placeholder="Enter Printed Notes" style="resize:none">{{$hold->printed_notes}}</textarea>
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="hold_label" name="hold_label" placeholder="Enter Hold Label" value="{{$hold->hold_label}}" />
                                ...
                                <div class="row mb-2">
                                    <div class="col-8">
                                        ...
                                        <input type="text" class="form-control" id="job_name" name="job_name" vlaue="{{$hold->job_name}}" placeholder="Enter End Customer / Job Name" />
                                        <span class="text-danger error-text job_name_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="attn">Attn</label>
                                        <input type="text" class="form-control" id="attn" name="attn" placeholder="Enter Attn" value="{{$hold->attn}}" />
                                ...
                                <div class="row mb-2">
                                    <div class="col-8">
                                        ...
                                        <input type="text" class="form-control" id="address" placeholder="Enter Address" name="address" aria-label="Address" value="{{$hold->address}}" />
                                        <span class="text-danger error-text address_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="suite">Suite / Unit#</label>
                                        <input type="text" class="form-control" id="suite" placeholder="Enter Suite / Unit" name="suite" value="{{$hold->suite}}" aria-label="Suite / Unit" />
                                        <span class="text-danger error-text suite_error"></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="city" placeholder="Enter City" name="city" value="{{$hold->city}}" aria-label="City" />
                                        <span class="text-danger error-text ship_to_city_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="state">State</label>
                                        <input type="text" class="form-control" id="state" placeholder="Enter State" name="state" value="{{$hold->state}}" aria-label="State" />
                                        <span class="text-danger error-text ship_to_state_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="zip">Zip </label>
                                        <input type="text" class="form-control" id="zip" placeholder="Enter Zip" name="zip" value="{{$hold->zip}}" aria-label="Zip" />
                                ...
                                <div class="row mb-2">
                                    <div class="col-4">
                                        ...
                                        <select id="country_id" name="country_id" class="select2 form-select" data-allow-clear="true">
                                            <option value="">--select--</option>
                                            @foreach($data['countries'] as $id => $country_name)
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->country_id == $id ? 'selected' : '' }}>{{ $country_name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone" value="{{$hold->phone}}" />
                                        <span class="text-danger error-text ship_to_phone_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="fax">Fax</label>
                                        <input type="text" class="form-control" id="fax" placeholder="Enter Fax" name="fax" value="{{$hold->fax}}" aria-label="ship_to_Fax" />
                                ...
                                <div class="row mb-2">
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="mobile" placeholder="Enter Mobile" name="mobile" value="{{$hold->mobile}}" aria-label="Mobile" />
                                        <span class="text-danger error-text ship_to_mobile_error"></span>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="email">Email</label>
                                        <input type="text" class="form-control" id="email" placeholder="Enter Email" name="email" value="{{$hold->email}}" aria-label="Email" />
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select id="delivery_type" name="delivery_type" class="select2 form-select" data-allow-clear="true">
                                            <option value="">--select--</option>
                                            <option value="Pick Up" {{ isset($hold) && $hold->delivery_type == 'Pick Up' ? 'selected' : '' }}>Pick Up</option>
                                            <option value="Delivery" {{ isset($hold) && $hold->delivery_type == 'Delivery' ? 'selected' : '' }}>Delivery</option>
                                        </select>
                                ...
                                <div class="row mb-2">
                                    <div class="col-8">
                                        ...
                                        <select id="how_did_hear_about_us_id" name="how_did_hear_about_us_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($hold) && $hold->how_did_hear_about_us_id == $id ? 'selected' : '' }}>{{ $how_did_you_hear_option}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="mb-2 col-lg-11">
                                        ...
                                        <div class="d-flex">
                                            <div class="input-group flex-grow-1">
                                                <input type="text" class="form-control bg-label-secondary" readonly name="general_contractor_name" id="general_contractor_name" value="{{$generalContractor->associate_name??''}}" />
                                                <input type="hidden" id="general_contractor_id" name="general_contractor_id" value="{{$generalContractor->id??null}}" />
                                ...
                                <div class="row">
                                    <div class="mb-2 col-lg-11">
                                        ...
                                        <div class="d-flex">
                                            <div class="input-group flex-grow-1">
                                                <input type="text" class="form-control bg-label-secondary" readonly name="brand_name" id="brand_name" value="{{$brand->associate_name??''}}" />
                                ...
                                <div class="row">
                                    <div class="mb-2 col-lg-11">
                                        ...
                                        <div class="d-flex">
                                            <div class="input-group flex-grow-1">
                                                <input type="text" class="form-control bg-label-secondary" readonly name="referred_by_name" id="referred_by_name" value="{{$referredBy->associate_name??''}}" />
                                                <input type="hidden" id="referred_by_id" name="referred_by_id" value="{{$referredBy->id??''}}" />
                                                <span class="input-group-text bg-primary" data-bs-toggle="modal" data-bs-target="#searchAssociate">
                                                    <i class="fi fi-rr-search text-white"></i>
                                                </span>
                                            </div>
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-primary btn-md" id="nextStepAddProductBtn" name="nextStepAddProductBtn">Go To Next Step To Update Products</button>
