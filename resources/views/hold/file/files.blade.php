<div class="tab-pane" id="file" role="tabpanel">
    <h5 class="">Files</h5>
    <form id="uploadHoldFileForm" enctype="multipart/form-data">
        <div class="row">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                <div class="button-wrapper">
                    ...
                    <button type="submit" class="btn btn-secondary account-image-reset mb-4" data-id='{{ $hold->id }}' id="saveFile" name="saveFile">
        ...
        <table class="datatables-basic table tables-basic border-top table-striped" id="holdFile">
