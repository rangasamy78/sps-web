...
@section('title', 'Add Opportunity and Hold')
...
<div class="content-wrapper">
    <!-- Content -->
    <form id="opportunityHoldForm">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><a href="{{route('opportunities.index')}}" class="text-decoration-none text-dark">
                    Add Opportunity + Hold</span>
                </a></h4>
            <div class="app-ecommerce">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <input type="hidden" class="form-control" id="hold_code" readonly name="hold_code" aria-label="date" value="{{$holdCount+1}}" />
                                    ...
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <input type="date" class="form-control" id="expiry_date" name="expiry_date" aria-label="date" />
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-border btn-sm text-white bg-primary ms-auto fw-bold" data-bs-toggle="modal" data-bs-target="#AddNewCustomer">Add New</button>
                            </div>
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col">
                                    ...
                                    <div id="common-fields">
                                        <div class="row mb-2">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="hold_label" name="hold_label" placeholder="Enter Hold Name" />
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-primary btn-md" id="saveOpportunityHold" name="saveOpportunityHold">Add Opportunity + Hold</button>
...
@include('hold.create.__script_opportunity_holds')
@endsection