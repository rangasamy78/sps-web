            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        ...
                        <textarea type="text" class="form-control" row="3" id="survey_rating_notes" name="survey_rating_notes">{{$opportunity->survey_rating_notes}}</textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="saveSurvey" name="saveSurvey" data-id="{{$opportunity->id}}">Save</button>
