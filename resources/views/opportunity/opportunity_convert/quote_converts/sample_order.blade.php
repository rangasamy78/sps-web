                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <textarea class="form-control bg-label-warning text-dark" readonly rows="1" id="printed_notes">{{$quote->visit_printed_notes}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="sample_order_label" id="sample_order_label" placeholder="Enter Sample Order Label" value="{{$quote->quote_label}}">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" name="sample_order_date" id="sample_order_date" value="{{$quote->quote_date}}">
                                        <span class="text-danger error-text sample_order_date_error"></span>
                                    </div>
                                    <div class="col-lg-6 col-sm-12">
                                        <label class="form-label">Sample Order Time</label>
                                        <input type="time" class="form-control" name="sample_order_time" id="sample_order_time" value="{{$quote->quote_time}}">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select class="form-select select2" name="price_level_id" id="price_level_id" data-allow-clear="true">
                                            ...
                                            <option value="{{ $id }}" {{ isset($quote) && $quote->price_level_id == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <textarea class="form-control" rows="2" name="sample_order_printed_notes" id="sample_order_printed_notes" placeholder="Enter Printed Notes">{{$quote->quote_printed_note}}</textarea>
