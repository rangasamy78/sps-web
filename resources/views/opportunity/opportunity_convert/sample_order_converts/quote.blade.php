...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="app-ecommerce">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <textarea class="form-control bg-label-warning text-dark" readonly rows="1" id="sample_order_printed_notes_input">{{$sampleOrder->sample_order_printed_notes}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-sm-12">
            ...
            <!-- buttons for sampleOrder,holds,sample order,quotes -->
            <!-- //Quote Details -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="quote_label" id="quote_label" placeholder="Enter Quote Label" value="{{$sampleOrder->sample_order_label}}">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="secondary_sales_person_id" name="secondary_sales_person_id">
                                            ...
                                            <option value="{{ $id }}" {{ isset($sampleOrder) && $sampleOrder->sales_person_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="date" class="form-control" value="{{$sampleOrder->sampleOrder_date}}" name="quote_date" id="quote_date" value="{{$sampleOrder->sample_order_date}}">
                                        <span class="text-danger error-text quote_date_error"></span>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <label class="form-label" for="quote_time">Quote Time</label>
                                        <input type="time" class="form-control" name="quote_time" id="quote_time" value="{{$sampleOrder->sample_order_time}}">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select class="select2 form-select" id="price_level_id" name="price_level_id">
                                            ...
                                            <option value="{{ $id }}" {{ isset($sampleOrder) && $sampleOrder->price_level_id == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select class="select2 form-select" id="end_use_segment_id" name="end_use_segment_id">
                                            ...
                                            <option value="{{ $id }}" {{ isset($sampleOrder) && $sampleOrder->end_use_segment_id == $id ? 'selected' : '' }}>{{ $end_use_segment }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <select class="select2 form-select" id="project_type_id" name="project_type_id">
                                            ...
                                            <option value="{{ $id }}" {{ isset($sampleOrder) && $sampleOrder->project_type_id == $id ? 'selected' : '' }}>{{ $project_type_name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        ...
                                        <textarea class="form-control" rows="2" name="quote_printed_note" id="quote_printed_note" placeholder="Enter Printed Notes">{{$sampleOrder->sample_order_printed_notes}}</textarea>
                ...
                <div class="row mt-3">
                    <div class="card-datatable table-responsive">
                        <table class="datatables-basic table table-light table-hover" id="convertQuoteDatatable">
                            ...
                            <tbody>
                                @foreach ($sampleOrderProducts as $sampleOrderProduct)
                                <tr class="product-row">
                                    <td>
                                        <span>{{ $sampleOrderProduct->product->product_name }}</span>
                                        <input type="hidden" name="product_id[]" value="{{ $sampleOrderProduct->product_id }}">
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input me-2" name="is_sold_as[]" id="is_sold_as" value="1"
                                                {{ $sampleOrderProduct->is_sold_as ? 'checked' : '' }}>
                                            <label class="me-2 mb-0" style="font-size: 7pt;">Sold As:</label>
                                            <input type="text" class="form-control form-control-sm" name="description[]"
                                                value="{{ $sampleOrderProduct->description }}" style="width: 150px;">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <input type="number" class="form-control form-control-sm quantity" value="{{ $sampleOrderProduct->product_quantity }}" name="product_quantity[]" id="product_quantity[]" style="width: 90px;">
                                            <span>{{ $sampleOrderProduct->product->unit_measure->unit_measure_name ?? 'N/A' }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="me-1">$</span>
                                            <input type="text" class="form-control form-control-sm unit-price" value="{{ $sampleOrderProduct->product_unit_price }}"
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <input type="text" class="form-control form-control-sm amount" name="product_amount[]"
                                                value="{{ $sampleOrderProduct->product_amount }}" readonly style="width: 90px;">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="checkbox" class="form-check-input tax" name="is_tax[]" id="is_tax" value="1"
                                            {{ $sampleOrderProduct->is_tax ? 'checked' : '' }}>
                                    </td>
                                    <td>
                                ...
                                <tr class="service-row">
                                    <td>
                                        <span>{{$sampleOrderService->service->service_name}}</span>
                                        <input type="hidden" name="service_id[]" id="service_id[]" value="{{ $sampleOrderService->service_id }}">
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input me-2" name="is_sold_as[]" id="is_sold_as" value="1"
                                                {{ $sampleOrderService->is_sold_as ? 'checked' : '' }}>
                                            <label class="me-2 mb-0" style="font-size: 7pt;">Sold As:</label>
                                            <input type="text" class="form-control form-control-sm" name="description[]"
                                                value="{{ $sampleOrderService->description }}" style="width: 150px;">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <input type="number" class="form-control form-control-sm quantity" name="service_quantity[]"
                                                value="{{ $sampleOrderService->service_quantity }}" style="width: 90px;">
                                            <span>{{ $sampleOrderService->service->unit_measure->unit_measure_name ?? 'N/A' }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <input type="number" class="form-control form-control-sm unit-price" name="service_unit_price[]"
                                                value="{{ $sampleOrderService->service_unit_price }}" style="width: 90px;">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <input type="number" class="form-control form-control-sm amount" name="service_amount[]"
                                                value="{{ $sampleOrderService->service_amount }}" readonly style="width: 90px;">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="checkbox" class="form-check-input tax" name="is_tax[]" value="1"
                                            {{ $sampleOrderService->is_tax ? 'checked' : '' }}>
                                    </td>
                                    <td>
                                        <input type="checkbox" class="form-check-input tax" name="is_hide_line[]" id="is_hide_line" value="1">
                                    </td>
