                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="visit_label" id="visit_label" placeholder="Enter Visit Label" value="{{$sampleOrder->sample_order_label}}">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        ...
                                        <input type="date" class="form-control" name="visit_date" id="visit_date" value="{{$sampleOrder->sample_order_date}}">
                                        <span class="text-danger error-text visit_date_error"></span>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label">Visit Time</label>
                                        <input type="time" class="form-control" name="visit_time" id="visit_time" value="{{$sampleOrder->sample_order_time}}">
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="2" name="visit_printed_notes" id="visit_printed_notes" placeholder="Enter Printed Notes">{{$sampleOrder->sample_order_printed_notes}}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="3 " name="visit_internal_notes" id="visit_internal_notes" placeholder="Enter Internal Notes">{{$opportunity->internal_notes}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="product_description[]"
                                                value="{{ $sampleOrderProduct->product_description }}" style="width: 80px;">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="service-row">
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" name="service_description[]"
                                            value="{{ $sampleOrderService->service_description }}">
                                    </td>
                                    <td>
