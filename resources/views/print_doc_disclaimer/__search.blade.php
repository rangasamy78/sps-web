<div class="card">
    <div class="row g-3 mb-3 p-3">
        <label><b>Search Print Doc Disclaimer : </b></label>
        <div class="col-12 col-sm-6 col-lg-3">
            <input type="text" class="form-control dt-input dt-full-name" name="titleFilter" id="titleFilter" placeholder="Search Title">
        </div>
        <div class="col-12 col-sm-6 col-lg-3">
            <select class="form-select select2" name="select_type_category_id_filter[]" id="select_type_category_id_filter" multiple data-allow-clear="true">
