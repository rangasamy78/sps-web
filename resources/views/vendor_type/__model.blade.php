            ...
            <div class="modal-body">
                <form id="vendorTypeForm" name="vendorTypeForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="vendor_type_name" class="col-sm-6 form-label">Vendor Type Name <sup style="color:red; font-size: 0.9rem;"><strong>*</strong></label>
                        <div class="col-sm-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="showVendorTypeForm" name="showVendorTypeForm" class="form-horizontal">
                    <div class="form-group">
                        <label for="vendor_type_name" class="col-sm-6 form-label">Vendor Type Name</label>
                        <div class="col-sm-12">
