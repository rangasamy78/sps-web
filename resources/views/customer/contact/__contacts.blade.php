<div class="tab-pane fade show active" id="contact" role="tabpanel">
    <h5>Add Contact</h5>
    <table class="datatables-basic table table-striped" id="customerContact">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body my-auto">
            <div class="form-group mb-3">
                <input type="hidden" class="form-control" id="type" name="type" placeholder="Enter Title"
                    value="customer">
                <input type="hidden" class="form-control" id="type_id" name="type_id" placeholder="Enter Title"
                    value="{{ $customer->id }}">
                <label for="contact_name" class="form-label">Contact/Loc.Name <sup
            ...
            <div class="form-group mb-3">
                <div class="col-sm-12">
                    <input type="checkbox" id="is_ship_to_address" name="is_ship_to_address" value="1">
                    <label for="is_ship_to_address" class="form-label">This is a Shipto address</label>
                </div>
                <span class="text-danger error-text internal_notes_error"></span>
            </div>
            <div class="form-group mb-3 tax-code" style="display:none;">
                <label for="tax_code_id" class="form-label">Tax Code:</label>
                <div class="col-sm-12">
                    <select type="text" id="tax_code_id" name="tax_code_id" class="form-select">
