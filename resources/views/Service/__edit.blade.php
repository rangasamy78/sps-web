                                ...
                                <div class="row mb-5">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control" id="avg_est_cost" placeholder="$"
                                            name="avg_est_cost" aria-label="$" value="{{ $service->avg_est_cost }}" step="0.01" >
                                    </div>
                                    <div class="col mt-4">
                                        <label class="form-label mt-3" for="is_taxable_item">This Service is Taxable</label>&nbsp;
                            ...
                            <div class="card-body mb-4">
                                ...
                                <div class="row mb-3 mt-4">
                                    <div class="col-10">
                                        ...
                                        <textarea class="form-control" id="notes" name="notes" aria-label="Notes" style="line-height: 3;" placeholder="Notes">{{ $service->notes }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-10">
                                        ...
                                        <textarea class="form-control" id="internal_instruction" name="internal_instruction"
                                            aria-label="Special Instructions" style="line-height: 3;" placeholder="Special Instructions">{{ $service->internal_instruction }}</textarea>
                                        <span class="text-danger error-text notes_error"></span>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-10">
                                        ...
                                        <textarea class="form-control" id="disclaimer" name="disclaimer" aria-label="Disclaimer" style="line-height: 3;" placeholder="Disclaimer">{{ $service->disclaimer }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="homeowner_price"
                                        ...
                                        value="{{ $service->service_price->homeowner_price }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="bundle_price"
                                        ...
                                        value="{{ $service->service_price->bundle_price }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="special_price"
                                        ...
                                        value="{{ $service->service_price->special_price }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="loose_slab_price"
                                        ...
                                        value="{{ $service->service_price->loose_slab_price }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="bundle_price_sqft"
                                        ...
                                        value="{{ $service->service_price->bundle_price_sqft }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="special_price_per_sqft"
                                        ...
                                        value="{{ $service->service_price->special_price_per_sqft }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="owner_approval_price"
                                        ...
                                        value="{{ $service->service_price->owner_approval_price }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="loose_slab_per_slab"
                                        ...
                                        value="{{ $service->service_price->loose_slab_per_slab }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="bundle_price_per_slab"
                                        ...
                                        value="{{ $service->service_price->bundle_price_per_slab }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="special_price_per_slab"
                                        ...
                                        value="{{ $service->service_price->special_price_per_slab }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="owner_approval_price_per_slab"
                                        ...
                                        aria-label="" value="{{ $service->service_price->owner_approval_price_per_slab }}" step="0.01" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="price12" placeholder="Price12"
                                        name="price12" aria-label="" value="{{ $service->service_price->price12 }}" step="0.01" >
