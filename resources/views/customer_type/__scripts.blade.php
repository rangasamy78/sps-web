            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == "success") {
                        ...
                        table.draw();
                        var successMessage = type === 'POST' ? 'Customer Type Added Successfully!' : 'Customer Type Updated Successfully!';
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === "success") {
                        ...
                        showSuccessMessage('Deleted!', 'Customer Type Deleted Successfully!');
                    } else {
