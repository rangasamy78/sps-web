...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4 float-right"><span class="text-muted fw-light">Home /</span> Project Type</h4>
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons btn-group flex-wrap">
                                <button class="btn btn-secondary create-new btn-primary" type="button"
                                    id="createProjectType"><span><i class="bx bx-plus me-1"></i> <span
                                            class="d-none d-lg-inline-block">Create Project Type</span></span></button>
                            </div>
                        </div>
                    </div>
