            ...
            <div class="modal-body">
                <form id="receivingQcNoteForm" name="receivingQcNoteForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="code" class="col-sm-4 control-label">Code <sup style="color: red;"><strong>*</strong></sup></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group mt-3">
                        <label for="notes" class="col-sm-4 control-label">Notes <sup style="color: red;"><strong>*</strong></sup></label>
                        <div class="col-sm-12">
