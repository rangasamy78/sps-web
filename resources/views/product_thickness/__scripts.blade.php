    ...
    $(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'product_thickness_name',
                    name: 'product_thickness_name'
                },
                {
                    data: 'product_thickness_unit',
                    name: 'product_thickness_unit'
                },
                {
                    data: 'action',
                    name: 'action',
            ...
            buttons: [{
                text: '<i class="bx bx-plus me-sm-1"></i> <span class="d-none d-sm-inline-block" >Add Product Thickness</span>',
