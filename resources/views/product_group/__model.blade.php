            ...
            <div class="modal-body">
                <form id="productGroupForm" name="productGroupForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="Product Finish Code" class="col-sm-4 form-label">Product Group Name <sup style="color:red; font-size: 0.9rem;"><strong>*</strong></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group mt-3">
                        <label class="col-sm-4 form-label">Product Group Code </label>
                        <div class="col-sm-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="showProductGroupForm" name="showProductGroupForm" class="form-horizontal">
                    <div class="form-group">
                        <label for="Group" class="col-sm-4 form-label">Product Group Name </label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="product_group_name" name="product_group_name"
                                disabled value="">
                        </div>
