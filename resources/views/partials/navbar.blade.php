      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="avatar avatar-online">
            <img id="navbarUserImage" src="{{ Auth::user()->image ? asset('storage/app/public/' . Auth::user()->image) : asset('public/assets/img/avatars/1.png') }}" alt="" class="w-px-30 h-auto rounded-circle">
          </div>
        </a>
        <ul class="dropdown-menu dropdown-menu-end">
          <li>
            <a class="dropdown-item" href="{{route('user_profiles')}}">
              <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar avatar-online">
                    <img id="navbarUserImage1" src="{{ Auth::user()->image ? asset('storage/app/public/' . Auth::user()->image) : asset('public/assets/img/avatars/1.png') }}" alt="" class="w-px-40 h-auto rounded-circle">
                  </div>
                </div>
                <div class="flex-grow-1">
          ...
          <li>
            <a class="dropdown-item" href="{{ route('user_profile_updates') }}">
