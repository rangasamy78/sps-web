...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4 text-dark">Add Sample Order Product for Opportunity <span class="text-primary"> # {{$opportunity->opportunity_code}} </span></h4>
        <div class="app-ecommerce">
            <form id="sampleOrderProductForm">
                <div class="row">
                    <!-- first column -->
                ...
                <div class="row text-end mt-3">
                    <div class="col">
                        <button type="submit" class="btn btn-primary" id="saveSampleOrderProductBtn" name="saveSampleOrderProductBtn">Save Sample Order</button>
