...
@section('title', 'Add Opportunity and Sample Order')
...
<div class="content-wrapper">
    <!-- Content -->
    <form id="opportunitySampleOrderForm">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><a href="{{route('opportunities.index')}}" class="text-decoration-none text-dark"><span class="text-muted fw-light">Sample Order /</span>
                    Add Opportunity + Sample Order</span>
                </a></h4>
            <div class="app-ecommerce">
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="card mb-4 bankCard">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <h5 class="card-title mb-0">Sample Delivery Method</h5>
                                </div>
                                <div class="row mt-2">
                                    <div class="col">
                                ...
                                <!-- delivery type -->
                                <div id="sample_order_field" class="" style="display:none">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="delivery_tracking" placeholder="Enter Tracking" name="delivery_tracking" aria-label="Tracking" />
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="delivery_suite" placeholder="Enter Suite / Unit" name="delivery_suite" aria-label="City" />
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-primary btn-md" id="saveOpportunitySampleOrder" name="saveOpportunitySampleOrder">Add Opportunity + Sample Order</button>
...
@include('sample_order.create.__script_opportunity_sample_orders')
@endsection