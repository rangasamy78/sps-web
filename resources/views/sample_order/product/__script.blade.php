<script type="text/javascript">
    $(function() {
        ...
        var table_visit = $('#sampleOrderProductDataTable').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: false,
            ajax: {
                url: "{{ route('create.products.list',':id') }}".replace(':id', $('#sample_order_id').val()),
                type: 'GET',
                data: function(d) {},
            },
            columns: [{
        ...
        function calculateTotals() {
            ...
            $('#sample_order_sub_total').html('$' + subtotal.toFixed(2));
            $('#tax_code_amount_label').html('$' + tax.toFixed(2));
            $('#sample_order_total').html('$' + total.toFixed(2));
        }
