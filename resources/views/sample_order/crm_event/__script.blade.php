<script type="text/javascript">
    $(function() {
        ...
        var table_sample_order_event = $('#sampleOrderCrmEvent').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: false,
            ajax: {
                url: "{{ route('create.sample_order_events.list', ':id') }}".replace(':id', $('#sample_order_id').val()),
                type: 'GET',
                data: function(d) {
        ...
        $('#saveEvent').click(function(e) {
            ...
            $.ajax({
                url: '{{ route("create.sample_order_events.store") }}',
                type: 'POST',
                data: data,
                dataType: 'json',
        ...
        $(document).on("change", ".event_check", function() {
            ...
            $.ajax({
                url: '{{ route("create.sample_order_events.update", ":id") }}'.replace(':id', id),
                type: 'PUT',
                data: data,
                dataType: 'json',
                success: function(response) {
