<div class="tab-pane" id="CRMEvent" role="tabpanel">
    ...
    <table class="datatables-basic table tables-basic border-top table-striped" id="sampleOrderCrmEvent">
        ...
        <form id="addCrmEventForm" enctype="multipart/form-data">
            <div class="row">
                <div class="col">
                    ...
                    <input type="hidden" class="form-control" id="type" name="type" value="sampleOrder">
                    <input type="hidden" class="form-control" id="type_id" name="type_id" value="{{$sampleOrder->id}}">
