...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4 text-dark">Edit Sample Order Product for Opportunity <span class="text-primary"> # {{$opportunity->opportunity_code}} </span></h4>
        <div class="app-ecommerce">
            <form id="updatesampleOrderProductForm">
                <div class="row">
                    <!-- first column -->
                            ...
                            <div class="card-body">
                                <div class="row mb-1">
                                    <div class="col-sm-12 col-lg-6">
                                        ...
                                        <input type="hidden" class="form-control" id="sample_order_id" name="sample_order_id" value="{{$sampleOrder->id}}">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <textarea class="form-control mt-lg-3" rows="2" id="sample_order_printed_notes" name="sample_order_printed_notes">{{$sampleOrder->sample_order_printed_notes}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="card-datatable table-responsive">
                                                <table class="datatables-basic table tables-basic border-top table-striped" id="">
                                                    ...
                                                    <tbody id="sample_order_service">
                                                        @foreach ($sampleOrderServices as $sampleOrderService )
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" class="form-control" name="sample_order_service_id" id="sample_order_service_id" value="{{ $sampleOrderService->id }}">
                                                                <select class="form-control form-control-sm" name="service_id[]" style="width:150px">
                                                                    ...
                                                                    <option value="{{$id}}" {{ $sampleOrderService && $sampleOrderService->service_id == $id ? 'selected' : '' }}>{{$service_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                <span class="text-danger error-text service_id_error"></span>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm" name="service_description[]" value="{{$sampleOrderService->service_description}}">
                                                                <span class="text-danger error-text service_description_error"></span>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex p-1 gap-2">
                                                                    <input type="number" class="form-control form-control-sm service-quantity" name="service_quantity[]" style="width:50px" value="{{$sampleOrderService->service_quantity}}">
                                                                    ...
                                                                    <input type="number" class="form-control form-control-sm service-unit-price" name="service_unit_price[]" style="width:50px" value="{{$sampleOrderService->service_unit_price}}">
                                                                    <span class="text-dark fw-bold" style="font-size:8pt; white-space: nowrap;">= $</span>
                                                                    <input type="number" class="form-control form-control-sm service-amount" readonly name="service_amount[]" style="width:50px" value="{{$sampleOrderService->service_amount}}">
                                                                </div>
                                                                <span class="text-danger error-text _error"></span>
                                                            </td>
                                                            <td>
                                                                <input type="checkbox" class="form-check-input tax-check" value="1" name="is_tax[]" {{ isset($sampleOrderService->is_tax) && $sampleOrderService->is_tax ? 'checked' : '' }}>
                                        ...
                                        <div class="row mt-3">
                                            <div class="card-datatable table-responsive">
                                                <table class="datatables-basic table tables-basic border-top table-striped" id="">
                                                    ...
                                                    <tbody id="sample_order_product">
                                                        @foreach ($sampleOrderProducts as $index => $sampleOrderProduct)
                                                        @php
                                                        $imageSrc = ($index === 0)
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" class="form-control" name="sample_order_product_id" id="sample_order_product_id" value="{{ $sampleOrderProduct->id }}">
                                                                <span style="font-size: 8pt;">{{ $sampleOrderProduct->product_name }}</span>
                                                                <div class="d-flex align-items-center mt-1">
                                                                    <input type="hidden" class="form-control" name="product_id[]" id="product_id[]" value="{{ $sampleOrderProduct->product_id }}">
                                                                    <input type="checkbox" class="form-check-input me-2" id="is_sold_as[]" value="1" name="is_sold_as[]"
                                                                        {{ isset($sampleOrderProduct->is_sold_as) && $sampleOrderProduct->is_sold_as ? 'checked' : '' }}>
                                                                    <label class="text-dark fw-bold me-2 mb-0" style="font-size: 7pt; white-space: nowrap;">Sold As:</label>
                                                                    <input type="text" class="form-control form-control-sm" value="{{ $sampleOrderProduct->product_description }}"
                                                                        id="product_description[]" name="product_description[]" style="width: 80px;">
                                                                </div>
                                                                <span class="text-danger error-text product_id_error"></span>
                                                            </td>

                                                            <td><input type="number" class="form-control form-control-sm product-quantity" value="{{ $sampleOrderProduct->product_quantity }}" name="product_quantity[]" id="product_quantity[]" data-id="{{ $sampleOrderProduct->product_id }}" style="width: 80px;"><label class="text-dark fw-bold me-2 mb-0" style="font-size: 7pt;white-space: nowrap;">Sample Quantity:</label><input type="text" class="form-control form-control-sm" value="{{ $sampleOrderProduct->sample_quantity }}" id="sample_quantity[]" name="sample_quantity[]" style="width: 80px;"><span class="text-danger error-text sample_quantity_error"></span></td>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="me-1">$</span>
                                                                    <input type="number" class="form-control product-price form-control-sm"
                                                                        name="product_unit_price[]" id="product_unit_price[]"
                                                                        value="{{ $sampleOrderProduct->product_unit_price }}"
                                                                        data-id="{{ $sampleOrderProduct->product_id }}" style="width: 80px;">
                                                                    <img src="{{ asset('public/images/icon_additionalcharge.png') }}"
                                                                        ...
                                                                        data-id="{{ $sampleOrderProduct->product_id }}" id="product_price_list">
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-sm product-amount"
                                                                        ...
                                                                        value="{{ $sampleOrderProduct->product_amount }}" readonly style="width: 60px;">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <button type="button"
                                                                    ...
                                                                    value="{{ $sampleOrderProduct->id }}"
                                                                    data-id="{{ $sampleOrderProduct->id }}">
                                                                    <i class="fi fi-rr-cross-circle text-danger fw-bold fs-4 delete-sample-order-product"></i>
                                                                </button>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                ...
                <div class="row text-end mt-3">
                    <div class="col">
                        <button type="submit" class="btn btn-primary" id="updatesampleOrderProductBtn" name="updatesampleOrderProductBtn">Update Sample Order</button>
                        <button type="button" class="btn btn-secondary" id="cancelsampleOrderProductBtn" name="cancelsampleOrderProductBtn">Cancel</button>
                    </div>
                </div>
            </form>
        </div>
...
<!-- / Content -->
@include('sample_order.create.__model')
<div class="content-backdrop fade"></div>
</div>

@endsection
@section('scripts')
@include('sample_order.edit.__script')
@endsection