                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <div class="row">
                                                <span class="text-dark"><i class="fi fi-rr-user-tag fw-bold fs-5"></i>{{$primarySale->first_name??''}}&nbsp;{{$primarySale->last_name??''}}</span>
                                            </div>
                                            @endif
            ...
            <form id="formUpdateSampleOrder">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="hidden" class="form-control" name="sample_order_id" id="sample_order_id" value="{{$sampleOrder->id}}">
                                        <label class="form-label">Sample Order Label</label>
                                        <input type="text" class="form-control" name="sample_order_label" id="sample_order_label" value="{{$sampleOrder->sample_order_label}}" placeholder="Enter Visit Label">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" name="sample_order_date" id="sample_order_date" value="{{$sampleOrder->sample_order_date}}">
                                        <span class="text-danger error-text sample_order_date_error"></span>
                                    </div>
                                    <div class="col-lg-6 col-sm-12">
                                        <label class="form-label">Sample Order Time</label>
                                        <input type="time" class="form-control" name="sample_order_time" id="sample_order_time" value="{{$sampleOrder->sample_order_time}}">
                                ...
                                <div id="delivery-fields" class="conditional-fields">
                                    <div class="row mt-2">
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="delivery_attn" placeholder="Enter Attn" name="delivery_attn" value="{{$sampleOrder->delivery_attn}}" aria-label="ShipTo Name" />
                                            <span class="text-danger error-text delivery_attn_error"></span>
                                        </div>
                                        <div class="col-lg-6 col-sm-12">
                                            <label class="form-label" for="delivery_tracking">Tracking #</label>
                                            <input type="text" class="form-control" id="delivery_tracking" placeholder="Enter Tracking" name="delivery_tracking" value="{{$sampleOrder->delivery_tracking}}" aria-label="Address" />
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-4 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="delivery_address" placeholder="Enter Address" name="delivery_address" value="{{$sampleOrder->delivery_address}}" aria-label="delivery_Address" />
                                            <span class="text-danger error-text delivery_address_error"></span>
                                        </div>
                                        <div class="col-lg-4 col-sm-12">
                                            <label class="form-label" for="delivery_suite">Address2</label>
                                            <input type="text" class="form-control" id="delivery_suite" placeholder="Enter Address2" name="delivery_suite" value="{{$sampleOrder->delivery_suite}}" aria-label="delivery_Address2" />
                                            <span class="text-danger error-text delivery_suite_error"></span>
                                        </div>
                                        <div class="col-lg-4 col-sm-12">
                                            <label class="form-label" for="delivery_city">City </label>
                                            <input type="text" class="form-control" id="delivery_city" placeholder="Enter City" name="delivery_city" value="{{$sampleOrder->delivery_city}}" aria-label="delivery_City" />
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="delivery_zip" placeholder="Enter Zip" name="delivery_zip" value="{{$sampleOrder->delivery_zip}}" aria-label="delivery_Zip" />
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            ...
                                            <select id="delivery_country_id" name="delivery_country_id" class="select2 form-select" data-allow-clear="true">
                                                ...
                                                <option value="{{ $id }}" {{ isset($sampleOrder) && $sampleOrder->delivery_country_id == $id ? 'selected' : '' }}>{{ $country_name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-8 col-sm-12">
                                            ...
                                            <select class="form-control" id="document_footer_id" name="document_footer_id">
                                                ...
                                                <option value="{{ $id }}" {{ isset($sampleOrder) && $sampleOrder->document_footer_id == $id ? 'selected' : '' }}>{{ $policy_name }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="3" name="sample_order_printed_notes" id="sample_order_printed_notes" placeholder="Enter Printed Notes">{{$sampleOrder->sample_order_printed_notes}}</textarea>
                ...
                <div class="row mt-2">
                    <div class="col text-end">
                        <button type="submit" class="btn btn-primary me-lg-2" name="nextStepAddProduct" id="nextStepAddProductBtn">Go To Next Step To Update Products</button>
