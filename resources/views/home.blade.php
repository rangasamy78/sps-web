        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            <ul class="p-0 m-0">
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                  <img src="{{ asset('public/assets/img/icons/unicons/wallet.png') }}" alt="User" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                  <img src="{{ asset('public/assets/img/icons/unicons/chart.png') }}" alt="User" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                  <img src="{{ asset('public/assets/img/icons/unicons/cc-success.png') }}" alt="User" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex">
                <div class="avatar flex-shrink-0 me-3">
                  <img src="{{ asset('public/assets/img/icons/unicons/cc-warning.png') }}" alt="User" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
                ...
                <div class="timeline-event">
                  ...
                  <div class="d-flex">
                    <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                      <img
                        src="{{ asset('public/assets/img/icons/misc/pdf.png') }}"
                        alt="PDF image"
                        width="23"
                        class="me-2" />
                ...
                <div class="timeline-event">
                  ...
                  <div class="d-flex flex-wrap">
                    <div class="avatar me-3">
                      <img src="{{ asset('public/assets/img/avatars/3.png') }}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div>
                ...
                <div class="timeline-event pb-0">
                  ...
                  <div class="d-flex align-items-center avatar-group">
                    <div
                      ...
                      <img src="{{ asset('public/assets/img/avatars/5.png') }}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div
                      class="avatar pull-up"
                      data-bs-toggle="tooltip"
                      ...
                      data-bs-placement="top"
                      title="Marrie Patty">
                      <img src="{{ asset('public/assets/img/avatars/12.png') }}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div
                      class="avatar pull-up"
                      data-bs-toggle="tooltip"
                      ...
                      data-bs-placement="top"
                      title="Jimmy Jackson">
                      <img src="{{ asset('public/assets/img/avatars/9.png') }}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div
                      class="avatar pull-up"
                      data-bs-toggle="tooltip"
                      ...
                      data-bs-placement="top"
                      title="Kristine Gill">
                      <img src="{{ asset('public/assets/img/avatars/6.png') }}" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div
                      class="avatar pull-up"
                      data-bs-toggle="tooltip"
                      ...
                      data-bs-placement="top"
                      title="Nelson Wilson">
                      <img src="{{ asset('public/assets/img/avatars/14.png') }}" alt="Avatar" class="rounded-circle" />
                    </div>
                  </div>
                </div>
              </li>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/chrome.png') }}"
                            alt="Chrome"
                            height="24"
                            class="me-2" />
                          <span>Chrome</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/safari.png') }}"
                            alt="Safari"
                            height="24"
                            class="me-2" />
                          <span>Safari</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/firefox.png') }}"
                            alt="Firefox"
                            height="24"
                            class="me-2" />
                          <span>Firefox</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/edge.png') }}"
                            alt="Edge"
                            height="24"
                            class="me-2" />
                          <span>Edge</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/opera.png') }}"
                            alt="Opera"
                            height="24"
                            class="me-2" />
                          <span>Opera</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/brave.png') }}"
                            alt="Brave"
                            height="24"
                            class="me-2" />
                          <span>Brave</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/vivaldi.png') }}"
                            alt="Vivaldi"
                            height="24"
                            class="me-2" />
                          <span>Vivaldi</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/uc.png') }}"
                            alt="UC Browser"
                            height="24"
                            class="me-2" />
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/windows.png') }}"
                            alt="Windows"
                            height="24"
                            class="me-2" />
                          <span>Windows</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/mac.png') }}"
                            alt="Mac"
                            height="24"
                            class="me-2" />
                          <span>Mac</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/ubuntu.png') }}"
                            alt="Ubuntu"
                            height="24"
                            class="me-2" />
                          <span>Ubuntu</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/cent.png') }}"
                            alt="Cent"
                            height="24"
                            class="me-2" />
                          <span>Cent</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/linux.png') }}"
                            alt="Linux"
                            height="24"
                            class="me-2" />
                          <span>Linux</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/fedora.png') }}"
                            alt="Fedora"
                            height="24"
                            class="me-2" />
                          <span>Fedora</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img
                            src="{{ asset('public/assets/img/icons/brands/vivaldi-os.png') }}"
                            alt="Vivaldi"
                            height="24"
                            class="me-2" />
                          <span>Vivaldi</span>
