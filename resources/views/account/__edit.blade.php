...
<div class="content-wrapper">
    ...
    <form id="accountEditForm">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><a href="{{route('accounts.index')}}" class="text-decoration-none text-dark"><span class="text-muted fw-light">Account /</span><span> Edit Account</span></a></h4>
            <div class="app-ecommerce">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-7">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="account_number" placeholder="Enter Account Number" name="account_number" aria-label="Supplier Name" value="{{$account->account_number}}" />
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="account_name" placeholder="Enter Account Name" name="account_name" aria-label="Supplier Name" value="{{$account->account_name}}" />
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <select id="account_type_id" name="account_type_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $accountType->id }}" {{ isset($account) && $account->account_type_id == $accountType->id ? 'selected' : '' }}>{{ $accountType->account_type_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col">
                                        ...
                                        <select id="account_sub_type_id" name="account_sub_type_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $accountSubType->id }}" {{ isset($account) && $account->account_sub_type_id == $accountSubType->id ? 'selected' : '' }}>{{ $accountSubType->sub_type_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <select id="special_account_type_id" name="special_account_type_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $specialAccountType->id }}" {{ isset($account) && $account->special_account_type_id == $specialAccountType->id ? 'selected' : '' }}>{{ $specialAccountType->special_account_type_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col">
                                        ...
                                        <select id="account_operating_location_id" name="account_operating_location_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $company->id }}" {{ isset($account) && $account->account_operating_location_id == $company->id ? 'selected' : '' }}>{{ $company->company_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="alternate_number" placeholder="Enter Alternate Number" name="alternate_number" aria-label="Alternate Number" value="{{$account->alternate_number}}" />
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="alternate_name" placeholder="Enter Alternate Name" name="alternate_name" aria-label="Alternate Name" value="{{$account->alternate_name}}" />
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <select id="is_sub_account_of_id" name="is_sub_account_of_id" class="select2 form-select" data-allow-clear="true">
                                            <option value="">--select--</option>
                                            @foreach($isSubAccountTypes as $isSubAccountType)
                                            <option value="{{ $isSubAccountType->id }}" {{ isset($account) && $account->is_sub_account_of_id == $isSubAccountType->id ? 'selected' : '' }}>{{ $isSubAccountType->account_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select id="currency_id" name="currency_id" class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="{{ $currency->id }}" {{ isset($account) && $account->currency_id == $currency->id ? 'selected' : '' }}>{{ $currency->currency_name }}-{{ $currency->currency_code }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="statement_end_day" placeholder="Enter Statement End Day" name="statement_end_day" aria-label="Statement End Day" value="{{$account->statement_end_day}}" />
                        ...
                        <div class="card mb-4 bankCard" style="{{ $display }}">
                            <div class="card-header">
                                    ...
                                    <div data-repeater-item>
                                        <div class="row mb-1">
                                            <div class="mb-3 col-12 col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="bank_name" placeholder="Enter Bank Name" name="bank_name" aria-label="Bank Name" value="{{$account->bank_name}}" />
                                                <span class="text-danger error-text bank_name_error"></span>
                                            </div>

                                            <div class="mb-3 col-12 col-lg-4">
                                                <label class="form-label mb-1" for="branch_name">Branch Name</label>
                                                <input type="text" class="form-control" id="branch_name" placeholder="Enter Branch Name" name="branch_name" aria-label="Branch Name" value="{{$account->branch_name}}" />
                                                <span class="text-danger error-text branch_name_error"></span>
                                            </div>
                                            <div class="mb-3 col-12 col-lg-4">
                                                <label class="form-label mb-1" for="manager_name">Manager Name</label>
                                                <input type="text" class="form-control" id="manager_name" placeholder="Enter Manager Name" name="manager_name" aria-label="Manager Name" value="{{$account->manager_name}}" />
                                        ...
                                        <div class="row mb-1">
                                            <div class="mb-3 col-12 col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="phone" placeholder="Enter Phone" name="phone" aria-label="Phone" value="{{$account->phone}}" />
                                                <span class="text-danger error-text phone_error"></span>
                                            </div>
                                            <div class="mb-3 col-12 col-lg-4">
                                                <label class="form-label mb-1" for="fax">Fax</label>
                                                <input type="text" class="form-control" id="fax" placeholder="Enter Fax" name="fax" aria-label="Fax" value="{{$account->fax}}" />
                                                <span class="text-danger error-text fax_error"></span>
                                            </div>
                                            <div class="mb-3 col-12 col-lg-4">
                                                <label class="form-label mb-1" for="website">Website</label>
                                                <input type="text" class="form-control" id="website" placeholder="Enter Website" name="website" aria-label="Website" value="{{$account->website}}" />
                                        ...
                                        <div class="row mb-1">
                                            <div class="mb-3 col-12 col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="swift_code" placeholder="Enter Swift Code" name="swift_code" aria-label="Swift Code" value="{{$account->swift_code}}" />
                                            ...
                                            <div class="mb-3 col-12 col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="routing_number" placeholder="Enter Routing Number" name="routing_number" aria-label="Routing Number" value="{{$account->routing_number}}" />
                                            ...
                                            <div class="mb-3 col-12 col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="bank_account_number" placeholder="Enter Account Number" name="bank_account_number" aria-label="Account Number" value="{{$account->bank_account_number}}" />
                                                <span class="text-danger error-text bank_account_number_error"></span>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col d-flex align-items-center">
                                                <input class="form-check-input" type="checkbox" value="1" id="is_allow_printing_checks" name="is_allow_printing_checks" {{ isset($account) && $account->is_allow_printing_checks == 1 ? 'checked' : '' }} />
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_default_account" name="is_default_account" {{ isset($account) && $account->is_default_account == 1 ? 'checked' : '' }} />
                                ...
                                <div class="row mb-4">
                                    <div class="col d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_budgeted_account" name="is_budgeted_account" {{ isset($account) && $account->is_budgeted_account == 1 ? 'checked' : '' }} />
                                ...
                                <div class="row mb-4">
                                    <div class="col d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_tax_account" name="is_tax_account" {{ isset($account) && $account->is_tax_account == 1 ? 'checked' : '' }} />
                                ...
                                <div class="row mb-4">
                                    <div class="col d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_reconciled_account" name="is_reconciled_account" {{ isset($account) && $account->is_reconciled_account == 1 ? 'checked' : '' }} />
                                ...
                                <div class="row mb-4">
                                    <div class="col d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_allow_bank_reconciliation" name="is_allow_bank_reconciliation" {{ isset($account) && $account->is_allow_bank_reconciliation == 1 ? 'checked' : '' }} />
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="mb-3 col">
                                        ...
                                        <textarea id="internal_notes" name="internal_notes" class="form-control" rows="3" placeholder="Enter Internal Notes" style="resize:none">{{$account->internal_notes}}</textarea>
                                        <span class="text-danger error-text internal_notes_error"></span>
                                    </div>
                                </div>
                                <div class="row">
                                    <input type="hidden" class="form-control" id="status" name="status" value="{{$account->status}}" aria-label="status" />
                                </div>
                            </div>
                        </div>
                        <!-- /remit to address Card -->
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-primary btn-md" id="savedata" name="savedata">Update Account</button>
