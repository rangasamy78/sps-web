<script type="text/javascript">
    $(function() {
        ...
        var table_accountfile = $('#accountFile').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: false,
            ajax: {
                url: "{{ route('account_files.list') }}",
                type: 'GET',
                data: function(d) {
        ...
        $('#saveFile').click(function(e) {
            ...
            $.ajax({
                url: '{{ route("account_files.store") }}', // Your upload route
                type: 'POST',
                data: formData,
        ...
        $(document).on('click', '.updateFile', function(e) {
            ...
            $.ajax({
                url: "{{ route('account_files.update', ':id') }}".replace(':id', id),
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.status === 'success') {
        ...
        function deleteAccountFile(id) {
            var url = "{{ route('account_files.destroy', ':id') }}".replace(':id', id);
            $.ajax({
                url: url,
                type: "DELETE",
                data: {
