            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == "success") {
                        ...
                        table.draw();
                        var successMessage = type === 'POST' ? 'Product Color Added Successfully!' : 'Product Color Updated Successfully!';
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === "success") {
                        ...
                        showSuccessMessage('Deleted!', 'Product Color Deleted Successfully!');
                    } else {
