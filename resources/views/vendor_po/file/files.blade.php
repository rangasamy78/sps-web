<div class="tab-pane" id="files" role="tabpanel">
    ...
    <form id="uploadFileForm" enctype="multipart/form-data">
            ...
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                <div class="button-wrapper">
                    <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                        ...
                        <input type="file" id="upload" class="vendor-po-file-input" hidden
                    ...
                    <button type="submit" class="btn btn-secondary account-image-reset mb-4"
                        data-id='{{ $vendor_po->id }}' id="saveFile" name="saveFile">
        ...
        <div class="row">
            <input type="text" class="form-control" hidden name="vendor_po_id" id="vendor_po_id"
                value="{{ $vendor_po->id }}">
        </div>
