    ...
    $(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'select_type_category_names',
                    name: 'select_type_category'
                },
                {
                    data: 'select_type_sub_categories',
                    name: 'select_type_sub_category'
                },
                {
                    data: 'action',
                    name: 'action',
        ...
        $('body').on('click', '.editbtn', function() {
            ...
            $.get("{{ route('select_type_sub_categories.index') }}" + '/' + id + '/edit', function(data) {
                ...
                $('#select_type_category_id').val(data.id).trigger('change');
