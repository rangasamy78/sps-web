        ...
        <div class="col-lg-7 col-md-10 col-sm-12">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <input type="hidden" id="account_receivable_aging_period_id" readonly class="form-control lblPeriod" name="account_receivable_aging_period_id" value="{{ isset($accountReceivableAgingPeriod['id']) ? $accountReceivableAgingPeriod['id'] : 0 }}">
              </div>
              <!-- invoice Date -->
              <div id="invoice_date" style="display:none">
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" id="ar_invoice_date_start_1" readonly class="form-control lblPeriod" name="ar_invoice_date_start_1" value="0">
                    </div>
                  </div>
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" id="ar_invoice_date_start_2" readonly class="form-control lblPeriod" name="ar_invoice_date_start_2" value="{{isset($accountReceivableAgingPeriod['ar_invoice_date_start_2']) ? $accountReceivableAgingPeriod['ar_invoice_date_start_2'] : null;}}">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" class="form-control lblPeriod" readonly name="ar_invoice_date_start_3" id="ar_invoice_date_start_3" value="{{isset($accountReceivableAgingPeriod['ar_invoice_date_start_3']) ? $accountReceivableAgingPeriod['ar_invoice_date_start_3'] : null;}}">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" class="form-control lblPeriod" readonly name="ar_invoice_date_start_4" id="ar_invoice_date_start_4" value="{{isset($accountReceivableAgingPeriod['ar_invoice_date_start_4']) ? $accountReceivableAgingPeriod['ar_invoice_date_start_4'] : null;}}">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
              ...
              <div id="due_date">
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" id="ar_due_date_start_2" readonly class="form-control lblPeriod" name="ar_due_date_start_2" value="1">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" class="form-control lblPeriod" readonly name="ar_due_date_start_3" id="ar_due_date_start_3" value="{{isset($accountReceivableAgingPeriod['ar_due_date_start_3']) ? $accountReceivableAgingPeriod['ar_due_date_start_3'] : null;}}">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" class="form-control lblPeriod" readonly name="ar_due_date_start_4" id="ar_due_date_start_4" value="{{isset($accountReceivableAgingPeriod['ar_due_date_start_4']) ? $accountReceivableAgingPeriod['ar_due_date_start_4'] : null;}}">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
                ...
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="input-group input-group-merge">
                      <input type="number" class="form-control lblPeriod" readonly name="ar_due_date_start_5" id="ar_due_date_start_5" value="{{isset($accountReceivableAgingPeriod['ar_due_date_start_5']) ? $accountReceivableAgingPeriod['ar_due_date_start_5'] : null;}}">
                    </div>
                  </div>
                  <div class="col-12 col-md-1 text-center text-md-start">
