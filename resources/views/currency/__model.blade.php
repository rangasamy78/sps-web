            ...
            <div class="modal-body">
                <form id="currencyForm"  class="form-horizontal">
                    ...
                    <div class="form-group mb-2 p-1">
                        <label for="name" class=" control-label pb-1">Currency Code<sup style="color:red"><strong>*</strong></sup></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group mb-2 p-1">
                        <label for="name" class=" control-label pb-1">Currency (Symbol)<sup style="color:red"><strong>*</strong></sup></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group mb-2 p-1">
                        <label for="name" class=" control-label pb-1">Exchange Rate<sup style="color:red"><strong>*</strong></sup></label>
                        <div class="col-sm-12">
