                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2 row">
                        ...
                        <div class="col-12 col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="extended_amount" name="extended_amount"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-12 col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_not_in_stock"
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" class="form-control" id="supplier_description"
                        ...
                        <div class="col-12 col-md-2">
                            <div class="form-group">
                                ...
                                <input class="form-check-input ms-3" type="checkbox" id="is_hideon_print"
                    ...
                    <div class="form-group mb-2 row">
                        <div class="col-12 col-md-6">
                            ...
                            <input class="form-check-input ms-3" type="radio" id="inventory_restriction_slab"
                                name="pick_ticket_restriction" value="slab" checked>
                            <label for="inventory_restriction_slab">Slab</label>
                            <input class="form-check-input ms-2" type="radio" id="inventory_restriction_lot"
                                name="pick_ticket_restriction" value="lot">
                            <label for="inventory_restriction_lot">Lot</label>
                            <input class="form-check-input ms-2" type="radio" id="inventory_restriction_product"
                                name="pick_ticket_restriction" value="product">
                            <label for="inventory_restriction_product">Product</label>
                        </div>
                        <div class="col-12 col-md-6">

                            <div class=" text-end">
                                <button type="submit" class="btn btn-primary" id="soitemsavedata"
                                    value="create">Save & Close</button>
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-profile" role="tabpanel">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="search_product_name_sku"
                                            name="search_product_name_sku">
                                    </div>
                                    <div class="col-2">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <select class="form-select" id="search_product_type"
                                    ...
                                    <div class="col-2">
                                        ...
                                        <select class="form-select" id="search_category_type"
                                            name="search_category_type">
                                            <option></option>
                                            @foreach ($data['productCategories'] as $id => $product_category_name)
                                                <option value="{{ $id }}">{{ $product_category_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-2">
                                        ...
                                        <select class="form-select" id="search_group" name="search_group"
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        ...
                                        <input type="text" class="form-control" id="search_serial_num"
                                            name="search_serial_num">
                                    </div>
                                    <div class="col-2">
                                        <label class="form-label">Lot/Block</label>
                                        <input type="text" class="form-control" id="search_lot_block"
                                            name="search_lot_block">
                                    </div>
                                    <div class="col-2">
                                        <label class="form-label">Bundle</label>
                                        <input type="text" class="form-control" id="search_bundle"
                                            name="search_bundle">
                                    </div>
                                    <div class="col-2">
                                        <label class="form-label">Supp. Ref</label>
                                        <input type="text" class="form-control" id="search_supp_ref"
                                            name="search_supp_ref">
                                    </div>
                                    <div class="col-2">
                                        <label class="form-label">Bin</label>
                                        <input type="text" class="form-control" id="search_bin"
                                            name="search_bin">
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="form-group mb-2 row mt-3">
                                    <div class="col-12 col-md-6">
                                        <input class="form-check-input ms-3" type="checkbox" id="show_only_available"
                                            name="show_only_available" checked>
                                        <label for="is_taxable">Show Only Available</label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class=" text-end">
                                            <button type="button" class="btn btn-primary" id="searchProductBtn"
                                                name="searchProductBtn">Search</button>
                                            <button type="button" class="btn btn-secondary reset_search">Reset
                                                Search</button>
                                        </div>
                                    </div>
                                </div>
                ...
                <form id="serviceForm" name="serviceForm" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="extended_amount" class="form-label">Extended</label>
                                <input type="number" class="form-control" id="extended_amount"
                                    name="extended_amount" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <input class="form-check-input" type="checkbox" id="is_hideon_print"
                                    name="is_hideon_print">
