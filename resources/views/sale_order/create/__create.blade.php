                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                            <label class="form-label" for="so_number">SO #
                                                <sup style="color:red; font-size: 0.9rem;"><strong>*</strong></label>
                                            <input type="text" class="form-control bg-label-secondary" id="so_number"
                                                name="so_number" aria-label="so_number" readonly
                                                value="{{ $newSo }}" />
                                            <span class="text-danger error-text so_number_error"></span>
                                        </div>
                                        <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                            <input type="hidden" class="form-control" id="sales_order_id"
                                                name="sales_order_id">
                                            <input type="hidden" class="form-control" id="sales_order_code"
                                                name="sales_order_code" value="{{ $newSo }}">
                                            ...
                                            <input type="date" class="form-control" id="sales_order_date"
                                                name="sales_order_date" aria-label="date" value="{{ date('Y-m-d') }}" />
                                        ...
                                        <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                            ...
                                            <input type="text" class="form-control" id="customer_po_code"
                                                name="customer_po_code" aria-label="customer_po_code" value="" />
                                        </div>
                                        <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-6">
                                            <label class="form-label" for="price_level_label_id">Price Level </label>
                                            ...
                                            <div class="row mb-1">
                                                <div class="mb-3 col">
                                                    ...
                                                    <textarea id="special_instructions" name="special_instructions" class="form-control" rows="3"
                                                        placeholder="Enter Special / Delivery Instruction" style="resize:none"></textarea>
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <textarea id="printed_notes" name="printed_notes" class="form-control" rows="3"
                                                        placeholder="Enter Printed Notes" style="resize:none"></textarea>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" class="form-control" id="ship_to_state"
                                                        placeholder="Enter State" name="ship_to_state"
                                                        aria-label="State" />
                                        ...
                                        <div id="common-fields">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" class="form-control" id="ship_to_email"
                                                        placeholder="Enter Email" name="ship_to_email"
                                                        aria-label="Email" />
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-12 col-sm-6 mb-3">
                                                    <label class="form-label" for="sales_tax_id">Sales Tax<sup
                                                            style="color:red; font-size: 0.9rem;"><strong>*</strong></label>
                                                    <select id="sales_tax_id" name="sales_tax_id"
                                                        class="select2 form-select" data-allow-clear="true">
                                                        <option value="">--select--</option>
                                                        @foreach ($data['salesTaxs'] as $id => $tax_name)
                                                            <option value="{{ $id }}">{{ $tax_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
