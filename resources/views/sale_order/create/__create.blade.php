                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        ...
                                        <input type="text" class="form-control bg-label-secondary" id="so_number"
                                             name="so_number" aria-label="so_number" readonly value="{{$newSo}}" />
                                        <span class="text-danger error-text so_number_error"></span>
                                    </div>
                                    <div class="col-lg-2 col-sm-4 col-md-3 pt-sm-2">
                                        <input type="hidden" class="form-control" id="sales_order_id" name="sales_order_id">
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_cod" name="is_cod" />
                        ...
                        <div class="card mb-4 bankCard">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" id="shipping_tracking_number" name="shipping_tracking_number" aria-label="shipping_tracking_number" />
                                </div>
                            </div>
                                    ...
                                    <div data-repeater-item>
                                        <div class="row mb-1">
                                            <div class="mb-3 col">
                                                ...
                                                <textarea id="special_instructions" name="special_instructions" class="form-control" rows="3" placeholder="Enter Special / Delivery Instruction" style="resize:none"></textarea>
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <textarea id="printed_notes" name="printed_notes" class="form-control" rows="3" placeholder="Enter Printed Notes" style="resize:none"></textarea>
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <textarea class="form-control" id="print_doc_description_editor" name="print_doc_description_editor" rows="2" style="resize:none;display:none"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="common-fields">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-sm-3 mb-3">
                                                ...
                                                <input class="form-control" type="date" id="requested_ship_date" name="requested_ship_date" />
                                            </div>
                                            <div class="col-12 col-sm-3 mb-3">
                                                <label class="form-label ps-2 mb-0" for="est_delivery_date"> ETA Date</label>
                                                <input class="form-control" type="date" id="est_delivery_date" name="est_delivery_date" />
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-3 mb-3">
                                        ...
                                        <input class="form-control" type="text" id="commission_amount" name="commission_amount" />
                                    </div>
                                    <div class="col-12 col-sm-8 mb-3">
                                        <label class="form-label ps-2 mb-0" for="commission_notes"> Commission Notes</label>
                                        <input class="form-control" type="text" id="commission_notes" name="commission_notes" />
                                    </div>
                                </div>
                                <div class="row">
