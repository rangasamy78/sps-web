    ...
    <form id="pickTicketForm" name="pickTicketForm" class="form-horizontal">
        ...
        <table class="datatables-basic table tables-basic border-top table-striped" id="salesOrderline">
            <thead class="table-header-bold">
                <tr>
                    <th><input type="checkbox" class="form-check-input" style="transform:scale(1.2)" id="select-all"
                            checked></th>
                    <th>SO</th>
                    ...
                    <th>Extended</th>
                    <th>Tax</th>
                    <th>Hide<input type="checkbox" class="form-check-input" style="transform:scale(1.2)" id="hide-all">
                    </th>
                </tr>
            </thead>
