                    ...
                    <div class="app-ecommerce">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h4 class="card-title mb-0 fw-bold">
                                            <span class="text-dark fw-bold">PickTicket for SO # {{ $sale_order->sales_order_code }} : {{ $sale_order->ship_to_job_name }} </span>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <label class="form-label text-dark fw-bold font-size" style="font-size:8pt">{{ $sale_order->ship_to_type }}</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-12 col-sm-3">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <label class="form-label text-dark fw-bold font-size" style="font-size:8pt">{{ $customer->customer_name }}</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-12 col-sm-3">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <label class="form-label text-dark fw-bold font-size" style="font-size:8pt">{{ $company->company_name }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-9">
                                                            <label class="text-dark fw-bold font-size">{{ $sale_order->ship_to_name }}</label><br />
                                                                {{$sale_order->ship_to_address}}<br />
                                                                {{$sale_order->ship_to_city}} {{$sale_order->ship_to_state}} {{$sale_order->ship_to_zip}}
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-1 mb-2">
                                                ...
                                                <label class="form-label text-dark fw-bold" style="font-size:9pt">{{ $sale_order->sales_order_code }}</label>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-2 mb-2">
                                                ...
                                                <select id="payment_term_id" name="payment_term_id" class="form-select select2" data-allow-clear="true">
                                                    ...
                                                    @foreach($data['paymentTerms'] as $payment_term)
                                                        <option value="{{ $payment_term->id }}">{{ $payment_term->payment_label }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-12 col-sm-1 mb-2">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-2 mb-2">
                                                ...
                                                <select id="freight_carrier_id" name="freight_carrier_id" class="form-select select2" data-allow-clear="true">
                                                    ...
                                                    <option value="{{ $expenditure->id }}">{{ $expenditure->expenditure_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-12 col-sm-2 mb-2">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-2 mb-2">
                                                ...
                                                <input class="form-control" type="number" id="commission_amount" name="commission_amount" value="{{$sale_order->commission_amount}}" />
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-sm-12">
                                                ...
                                                <textarea class="form-control"  id="internal_notes_input" rows="2">{{$sale_order->internal_notes}}</textarea></div>
                                        </div>
                                        <div class="row">
                                            <label class="form-label mb-0 fw-bold text-dark">Secondary Commission</label>
                                            <div class="col-12 col-sm-2">
                                                <span style="font-size:9pt">Amount</span><br />
                                                <input class="form-control" type="number" id="commission_notes" name="commission_notes" value="{{$sale_order->commission_notes}}" />
                                            </div>
                                            <div class="col-12 col-sm-4 mb-4">
                                                <span style="font-size:9pt">Notes</span><br />
                                                <textarea class="form-control" type="text" rows="3" id="commission_notes" name="commission_notes" value="{{$sale_order->commission_notes}}" ></textarea>
                                            </div>
                                        </div>
                                        <div class="card mb-4">
                                            <div class="card-body">
                                                            ...
                                                            <tbody id="pickTicketItemsBody">
                                                                @for ($i = 0; $i < 3; $i++) <tr>
                                                                    ...
                                                                    <td><input type="text"
                                                                            ...
                                                                            name="items[{{$i}}][item_item_description]"></td>
                                                                    <td><input type="text"
                                                                            class="form-control form-control-sm extended-input"
                                                                            name="items[{{$i}}][extended]" style="width: 80%;float: right;"></td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <input type="checkbox" class="is_tax"
                                                                                name="items[{{$i}}][is_tax]" style="width: 100%">
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <input type="checkbox" class="is_hideon_print"
                                                                                name="items[{{$i}}][is_hideon_print]" style="width: 100%">
                                                                        </div>
                                                                    </td>
                                                                    </tr>
                                                                    @endfor
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end gap-2">
                                <button type="submit" class="btn btn-primary btn-md" id="savedata" name="savedata">Create PickTicket</button>
