<script type="text/javascript">
  $(function() {
    ...
    $('#savedata').click(function(e) {
      ...
      var url = $('#sales_order_id').val() ? "{{ route('sale_orders.update', ':id') }}".replace(':id', $('#sales_order_id').val()) : "{{ route('sale_orders.store') }}";
      var type = $('#sales_order_id').val() ? "PUT" : "POST";
      var data = $('#sales_order_id').val() ? $('#saleOrderEditForm').serialize() + "&ship_to_type=" + activeDeliveryMethod : $('#saleOrderForm').serialize() + "&ship_to_type=" + activeDeliveryMethod;
