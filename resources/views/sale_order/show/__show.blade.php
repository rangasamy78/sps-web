    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><a href="{{ route('sale_orders.index') }}" class="text-decoration-none text-dark "><span
                        class="text-muted fw-light">Sale Order /</span><span> Show Sale Order</span></a></h4>
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title mb-0 fw-bold">
                                    <span class="text-dark fw-bold">Delivery Sale Order #
                                        {{ $sale_order->sales_order_code }} {{ $sale_order->ship_to_job_name }} @ <a
                                            href="{{ route('companies.index') }}">{{ $company->company_name }}</a></span>
                                </h4>
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('sale_orders.edit', $sale_order->id) }}"
                                        data-id="{{ $sale_order->id }}" class="btn btn-primary rounded-circle editbtn"
                                        data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top"
                                        data-bs-custom-class="tooltip-dark" title="Update Sale Order"
                                    ...
                                    <div class='dropdown ms-2'>
                                        <button type='button'
                                            ...
                                            <i class='fi fi-rr-redo icon-color fs-4' data-bs-toggle="tooltip"
                                                data-bs-offset="0,8" data-bs-placement="right"
                                                data-bs-custom-class="tooltip-dark" title="More"></i>
                                            <!-- Icon inside the button -->
                                        </button>
                                        <div class='dropdown-menu'>
                                            <a class='dropdown-item showbtn fw-bold text-dark'
                                                href='{{ route('sale_orders.index') }}'>
                                                <i class='bx bx-list-ul'></i> List All Sale Orders
                                            </a>
                                            <a class='dropdown-item fw-bold text-dark' href='javascript:void(0);'
                                                data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="right"
                                                data-bs-custom-class="tooltip-dark" title="coming soon">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col">
                                                ...
                                                <span id="print_name_value" class="d-block">
                                                    {{ $date }}
                                                    ({{ \Carbon\Carbon::parse($sale_order->updated_at)->format('h:i A') }})

                                                    <label for="created_by" class="form-label text-dark fw-bold font-size"
                                                        style="font-size:8pt">By</label>
                                                    <span id="created_by_value" style="font-size:9pt">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="row mb-2">
                                                <div class="col">
                                                    ...
                                                    <label for="created_by" class="form-label text-dark fw-bold"
                                                        style="font-size:8pt">Sales Tax</label>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="row mb-2">
                                            @if ($price_list->price_code)
                                                <div class="col-6">
                                                    ...
                                                    <label for="created_by" class="form-label text-dark fw-bold"
                                                        style="font-size:8pt">Price Level</label>
                                                </div>
                                            @endif
                                            @if ($payment_term->payment_label)
                                                <div class="col-6">
                                                    ...
                                                    <label for="created_by" class="form-label text-dark fw-bold"
                                                        style="font-size:8pt">Payment Terms</label>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <h6 class="bg-label-primary text-white text-center p-2 rounded">
                                            Bill To:
                                            <input type="hidden" class="form-input customer_id" id="customer_id"
                                                name="customer_id" value="{{ $customer->id }}">
                                            <span class="text-dark"
                                                style="font-size: 0.75rem;">{{ $customer->customer_name }}</span>
                                        </h6>
                                        <div class="row">
                                            <div class="col"><label
                                                    class="form-label">{{ $customer->address }}</label></div>
                                            <span>{{ $customer->city }} {{ $customer->state }}
                                                {{ $customer->zip }}</span>
                                        </div>
                                        @if ($sale_order->attn)
                                            <div class="row">
                                        ...
                                        @if ($customer->email)
                                            <div class="row">
                                                <div class="col"><i class='bx bx-envelope text-dark'></i><label
                                                        class="form-label ms-1">{{ $customer->email }}</label></div>
                                            </div>
                                        @endif
                                        @if ($sale_order->primary_sales_person_id)
                                            <div class="row">
                                                <div class="col"><i class='bx bx-user text-primary'></i><label
                                                        class="form-label ms-1">{{ $primary_sales->first_name . ' ' . $primary_sales->last_name }}</label>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($sale_order->secondary_sales_person_id)
                                            <div class="row">
                                                <div class="col"><i class='bx bx-group text-primary'></i><label
                                                        class="form-label ms-1">{{ $primary_sales->first_name . ' ' . $primary_sales->last_name }}</label>
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <h6 class="bg-label-primary text-white text-center p-2 rounded">
                                            Ship To:
                                            <span class="text-dark"
                                                style="font-size: 0.75rem;">{{ $sale_order->ship_to_name }}</span>
                                        </h6>
                                        @if ($sale_order->ship_to_address)
                                            <div class="row">
                                                <div class="col"><label
                                                        class="form-label">{{ $sale_order->ship_to_address }}</label>
                                                </div>
                                                <span>{{ $sale_order->ship_to_city }} {{ $sale_order->ship_to_state }}
                                                    {{ $sale_order->ship_to_zip }}</span>
                                            </div>
                                        @endif
                                        @if ($sale_order->ship_to_lot || $sale_order->ship_to_sub_division)
                                            <div class="row">
                                                <div class="col">
                                                    @if ($sale_order->ship_to_lot)
                                                        <span class="text-dark ms-1" style="font-size:0.75rem">Lot:
                                                        </span>{{ $sale_order->ship_to_lot }}
                                                    @endif
                                                    @if ($sale_order->ship_to_sub_division)
                                                        <span class="text-dark ms-1"
                                                            style="font-size:0.75rem">Subdivision:
                                                        </span>{{ $sale_order->ship_to_sub_division }}
                                                    @endif
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if ($sale_order->ship_to_phone)
                                            <div class="row">
                                                <div class="col"><i class='bx bx-phone-call text-dark'></i><label
                                                        class="form-label ms-1">{{ $sale_order->ship_to_phone }}</label>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($sale_order->ship_to_fax)
                                            <div class="row">
                                                <div class="col"><i class='bx bx-printer text-dark'></i><label
                                                        class="form-label ms-1">{{ $sale_order->ship_to_fax }}</label>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($sale_order->ship_to_email)
                                            <div class="row">
                                                <div class="col"><i class='bx bx-envelope text-dark'></i><label
                                                        class="form-label ms-1">{{ $sale_order->ship_to_email }}</label>
                                                </div>
                                            </div>
                                        @endif
                                        @if (!empty($freight_carrier->expenditure_name))
                                            <div class="row">
                                                <div class="col"><span class="text-dark ms-1"
                                                        style="font-size:0.75rem">Freight Carrier:</span><label
                                                        class="form-label ms-1">{{ $freight_carrier->expenditure_name ?? '' }}</label>
                                                </div>
                                            </div>
                                        @endif
                                        @if (!empty($route->county_name))
                                            <div class="row">
                                                <div class="col"><span class="text-dark ms-1"
                                                        style="font-size:0.75rem">Route:</span><label
                                                        class="form-label ms-1">{{ $route->county_name ?? '' }}</label>
                                                </div>
                                            </div>
                                        @endif
                                        @if (!empty($sale_order->shipping_tracking_number))
                                            <div class="row">
                                                <div class="col"><span class="text-dark ms-1"
                                                        style="font-size:0.75rem">Tracking#:</span><label
                                                        class="form-label ms-1">{{ $sale_order->shipping_tracking_number ?? '' }}</label>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <h6 class="bg-label-primary text-white text-center p-2 rounded">
                                            Location:
                                            <span class="text-dark"
                                                style="font-size: 0.75rem;">{{ $company->company_name }}</span>
                                        </h6>
                                        <div class="row">
                                            <div class="col"><span class="text-dark ms-1"
                                                    style="font-size:0.75rem">Customer PO#:</span><label
                                                    class="form-label ms-1">&nbsp;{{ $sale_order->customer_po_code ?? 'N/A' }}</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col"><span class="text-dark ms-1"
                                                    style="font-size:0.75rem">Referred By:</span><label
                                                    class="form-label ms-1">&nbsp;{{ $reffered_by->associate_name ?? 'N/A' }}</label>
                                            </div>
                                        </div>
                                        @if (!empty($sale_order->commission_amount))
                                            <div class="row">
                                                <div class="col"><span class="text-dark ms-1"
                                                        style="font-size:0.75rem">Commission Amount:</span><span
                                                        data-bs-toggle="tooltip" data-bs-offset="0,8"
                                                        data-bs-placement="top" data-bs-custom-class="tooltip-secondary"
                                                        data-bs-original-title="{{ 'Commission Amount ' . $sale_order->commission_amount ?? 'N/A' }}">
                                                        <label class="form-label ms-1">&nbsp;<i
                                                                class='bx bx-user bx-tada bx-flip-horizontal'></i></label></span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <h6
                                            class="bg-label-primary text-white text-center d-flex justify-content-between p-2 rounded">
                                            Associates:
                                        </h6>
                                        <div class="row">
                                            <div class="col"><span class="text-dark ms-1"
                                                    style="font-size:0.75rem">Fabricator:</span><label
                                                    class="form-label ms-1">&nbsp;{{ $fabricator->associate_name ?? 'N/A' }}</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col"><span class="text-dark ms-1"
                                                    style="font-size:0.75rem">Designer:</span><label
                                                    class="form-label ms-1">&nbsp;{{ $designer->associate_name ?? 'N/A' }}</label>
                                            </div>
                                        </div>
                                        <h6
                                            class="bg-label-primary text-white text-center d-flex justify-content-between p-2 rounded">
                                            Contacts:
                                            <span class="text-dark">
                                                <i class="bx bxs-plus-circle align-middle fs-6" data-bs-toggle="modal"
                                                    data-bs-target="#listCustomerContact"></i>
                                            </span>
                                        </h6>
                                        <div class="row">
                                            <div class="col showContact">
                                                @foreach ($contacts as $contact)
                                                    <div class="contact-item d-flex justify-content-between border-bottom align-items-center p-1 rounded mb-1"
                                                        style="font-size:0.75rem;"
                                                        id="contact_{{ $contact['sale_order_contact_id'] }}">
                                                        <span class="fw-semibold">{{ $contact['name'] }}</span>
                                                        <button
                                                            class="btn btn-label-danger btn-sm rounded-circle delete-contact p-2"
                                                            data-id="{{ $contact['sale_order_contact_id'] }}">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="alert alert-info bold">This is a Delivery -
                                                    {{ $sale_order->is_cod == 1 ? 'COD' : '' }}
                                                    Sale.</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="hidden" id="logged_in_user"
                                                value="{{ auth()->user()->first_name }}">
                                            <textarea rows="1" class="form-control" name="internal_notes" id="internal_notes"></textarea>
                                            <button type="button" class="btn ms-6" id="updateInternalNote"
                                                name="updateInternalNote">
