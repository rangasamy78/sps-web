    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-input sales_order_id" id="sales_order_id" name="sales_order_id"
                    value="{{ $sale_order->id }}">
            ...
            <div class="modal-footer d-flex justify-content-between">
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                    data-bs-target="#saveCustomerContactModal" id="setupNewContact">Setup New Contact</button>
                <div>
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary btn-sm" name="saveContact" id="saveContact"
                        data-bs-dismiss="modal">Add Selected Contacts</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <form id="saveCustomerContactForm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-6">
                            ...
                            <input type="hidden" class="form-control" name="type_id" id="type_id"
                                value="{{ $sale_order->billing_customer_id }}">
                            ...
                            <div class="row  mb-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="primary_phone"
                                        id="primary_phone" placeholder="Enter Primary Phone">
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="secondary_phone"
                                        id="secondary_phone" placeholder="Enter Secondary Phone">
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            ...
                            <textarea type="text" class="form-control internal_notes" name="internal_notes" id="internal_notes"
                                placeholder="Enter Internal Notes"></textarea>
                            <span class="text-danger error-text internal_notes_error"></span>
                        </div>
                        <div class="col-6">
                            <div class="form-check pt-4">
                                <input type="checkbox" class="form-check-input" id="is_ship_to_address"
                                    name="is_ship_to_address" value="1" onclick="toggleTaxCode()">
                                <label for="is_ship_to_address" class="form-check-label">This is a Shipto
                                    address</label>
                ...
                <div class="modal-footer">
                    <div>
                        <button type="button" class="btn btn-primary" name="saveCustContact"
                            id="saveCustContact">Save</button>
