...
class VendorPoFileRepository implements CrudRepositoryInterface
{
    use ImageUploadTrait;
    public function findOrFail(int $id)
    {
        return VendorPoFile::query()
            ->findOrFail($id);
    }

    public function store(array $data)
    {
        $vendorPoId = $data['vendor_po_id'];
    ...
    public function getVendorPoFileList($id)
    {
        $query = VendorPoFile::where('vendor_po_id', $id);
        return $query;
    }
    ...
    public function dataTable(Request $request, $id)
    {
        ...
        $PriceListLabels = $this->getVendorPoFileList($id);
        $total           = $PriceListLabels->count();
        $totalFilter = $this->getVendorPoFileList($id);
        $totalFilter = $totalFilter->count();
        $arrData = $this->getVendorPoFileList($id);
