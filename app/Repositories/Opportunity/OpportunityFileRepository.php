...
class OpportunityFileRepository implements CrudRepositoryInterface
{
    use ImageUploadTrait;
    public function findOrFail(int $id)
    {
        return OpportunityFile::query()
            ->findOrFail($id);
    }

    public function store(array $data)
    {
        $accountId = $data['opportunity_id'];
    ...
    public function getOpportunityFileList($id)
    {
        $query = OpportunityFile::where('opportunity_id', $id);
        return $query;
    }
    ...
    public function dataTable(Request $request, $id)
    {
        ...
        $PriceListLabels = $this->getOpportunityFileList($id);
        $total           = $PriceListLabels->count();

        $totalFilter = $this->getOpportunityFileList($id);
        $totalFilter = $totalFilter->count();

        $arrData     = $this->getOpportunityFileList($id);
