...
public function dataTable(Request $request)
{
    ...
    $arrData->map(function ($value) {
        ...
        $value->product_type = $value->product_type_id;
        $value->product_category = $value->product_category->product_category_name ?? '';
        $value->product_origin = $value->country->country_name ?? '';
        $value->product_colors = $value->product_color->product_color ?? '';
        $value->product_group = $value->product_group->product_group_name ?? '';
