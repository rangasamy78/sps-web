...
class ProductRepository implements CrudRepositoryInterface, DatatableRepositoryInterface
{
    ...
    public function dataStockTable(Request $request)
    {
        ...
        $arrData->map(function ($value, $i) {
            ...
            $value->product_group_id        = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_group->product_group_name ?? '') . "</a>";
            $value->product_origin_id       = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->country->country_name ?? '') . "</a>";
            $value->preferred_supplier_id   = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->preferred_supplier_id ?? '') . "</a>";
            $value->status                  = $value->status == 1
            ? '<button class="btn btn-success btn-sm change_status" data-id="' . $value->id . '">Active</button>'
            : '<button class="btn btn-danger btn-sm change_status" data-id="' . $value->id . '">Inactive</button>';
    ...
    public function dataPriceListTable(Request $request)
    {
        ...
        $arrData->map(function ($value, $i) {
            ...
            $value->product_sub_category_id       = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_sub_category->product_sub_category_name ?? '') . "</a>";
            $value->product_group_id              = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_group->product_group_name ?? '') . "</a>";
            $value->product_origin_id             = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_origin_id ?? '') . "</a>";
            $value->preferred_supplier_id         = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->preferred_supplier_id ?? '') . "</a>";
            $value->homeowner_price               = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->homeowner_price ?? '') . "</a>";
            $value->bundle_price                  = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->bundle_price ?? '') . "</a>";
            $value->special_price                 = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->special_price ?? '') . "</a>";
            $value->loose_slab_price              = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->loose_slab_price ?? '') . "</a>";
            $value->bundle_price_sqft             = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->bundle_price_sqft ?? '') . "</a>";
            $value->special_price_per_sqft        = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->special_price_per_sqft ?? '') . "</a>";
            $value->owner_approval_price          = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->owner_approval_price ?? '') . "</a>";
            $value->loose_slab_per_slab           = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->loose_slab_per_slab ?? '') . "</a>";
            $value->bundle_price_per_slab         = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->bundle_price_per_slab ?? '') . "</a>";
            $value->special_price_per_slab        = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->special_price_per_slab ?? '') . "</a>";
            $value->owner_approval_price_per_slab = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->owner_approval_price_per_slab ?? '') . "</a>";
            $value->price12                       = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_price->price12 ?? '') . "</a>";
            $value->status                        = $value->status == 1
            ? '<button class="btn btn-success btn-sm change_status" data-id="' . $value->id . '">Active</button>'
            : '<button class="btn btn-danger btn-sm change_status" data-id="' . $value->id . '">Inactive</button>';
            $value->action = "<div class='dropup'><button type='button' class='btn p-0 dropdown-toggle hide-arrow'
    ...
    public function dataCustomerPriceListTable(Request $request)
    {
        ...
        $arrData->map(function ($value, $i) {
            ...
            $value->product_name            = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_name ?? '') . "</a>";
            $value->product_sku             = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_sku ?? '') . "</a>";
            $value->product_kind_id         = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_kind_id ?? '') . "</a>";
            $value->product_type_id         = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_kind->product_kind_name ?? '') . "</a>";
            $value->product_category_id     = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_category_id ?? '') . "</a>";
            $value->product_sub_category_id = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_sub_category_id ?? '') . "</a>";
            $value->product_group_id        = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_group_id ?? '') . "</a>";
            $value->product_origin_id       = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->product_origin_id ?? '') . "</a>";
            $value->preferred_supplier_id   = "<a href='" . route('products.show', $value->id) . "' class='text-secondary'>" . ($value->preferred_supplier_id ?? '') . "</a>";
            $value->status                  = $value->status == 1
            ? '<button class="btn btn-success btn-sm change_status" data-id="' . $value->id . '">Active</button>'
