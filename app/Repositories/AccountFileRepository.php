...
class AccountFileRepository implements CrudRepositoryInterface, DatatableRepositoryInterface
{
    ...
    public function getAccountFileList($request)
    {
        $query = AccountFile::query();
        return $query;
    }
    ...
    public function dataTable(Request $request)
    {
        ...
        $PriceListLabels = $this->getAccountFileList($request);
        $total           = $PriceListLabels->count();

        $totalFilter = $this->getAccountFileList($request);
        $totalFilter = $totalFilter->count();

        $arrData     = $this->getAccountFileList($request);
