...
namespace App\Http\Requests\Visit\Convert;

use Illuminate\Foundation\Http\FormRequest;

class CreateConvertSampleOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'delivery_tracking' => 'nullable|string|max:100',
            'delivery_shipping_ui' => 'nullable|string|max:100',
            ...
            'delivery_phone' => 'nullable|string|max:100',
            'delivery_fax' => 'nullable|string|max:100',
            'delivery_email' => 'nullable|string|max:100',
