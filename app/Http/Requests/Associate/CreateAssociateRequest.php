...
class CreateAssociateRequest extends FormRequest
{
    ...
    {
        return [
            'associate_name' => 'required|string|max:255|unique:associates,associate_name',
            'associate_code' => 'nullable|unique:associates,associate_code',
            ...
            'email' => ['nullable', 'string', 'max:255', 'email', 'unique:associates,email'],
            'accounting_email' => ['nullable', 'string', 'max:255', 'email', 'unique:associates,email'],
        ];
    }
