...
class CreateOpportunityRequest extends FormRequest
{
    ...
    {
        return [
            'opportunity_code' => 'required|string|unique:opportunities,opportunity_code',
            ...
            'ship_to_lot' => 'nullable|string|max:50',
    ...
    {
        return [
            'ship_to_zip.required_if' => 'The delivery zip code is required when the delivery method is "Delivery".',
            'how_did_hear_about_us_id.required_if' => 'Please select an option for how the customer heard about us when the delivery method is "Delivery".',
            'pick_how_did_hear_about_us_id.required_if' => 'Please select an option for how the customer heard about us when the pick-up method is selected.',

            // Add custom messages for the other fields as well
        ];
    }
}
