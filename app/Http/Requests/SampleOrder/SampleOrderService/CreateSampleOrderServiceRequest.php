...
namespace App\Http\Requests\SampleOrder\SampleOrderService;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class CreateSampleOrderServiceRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'sample_order_id' => 'required|integer|exists:sample_orders,id',
