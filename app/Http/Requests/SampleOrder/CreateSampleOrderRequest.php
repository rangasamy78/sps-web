...
class CreateSampleOrderRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'zip' => 'nullable|string|max:20|regex:/^\d{4,10}$/', // Optional: Validate ZIP codes
            'country_id' => 'nullable|integer|exists:countries,id', // Ensures the country ID exists in the countries table
