...
use App\Repositories\SampleOrder\EventRepository;
use App\Http\Requests\SampleOrder\Event\CreateEventRequest;
...
class EventController extends Controller
{
    ...
    public function getSampleOrderEventDataTableList(Request $request, $id)
    {
