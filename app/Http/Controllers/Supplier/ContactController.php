...
use App\Repositories\Supplier\ContactRepository;
use App\Http\Requests\Supplier\Contact\CreateContactRequest;
...
class ContactController extends Controller
{
    ...
    public function getSupplierContactDataTableList(Request $request, $id)
    {
