...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('product.products', compact('product_type', 'product_color', 'product_category', 'country', 'product_group', 'product_thickness', 'product_finish', 'unit_measure', 'product_price_range'));
    ...
    public function store(CreateProductRequest $request)
    {
        try {
            $productData = $request->only(
                ...
                'unit_of_measure_id', 'product_weight', 'product_size', 'gl_inventory_link_account_id',
                'gl_income_account_id', 'gl_cogs_account_id', 'safety_stock', 'safety_stock_value',
                'reorder_qty', 'reorder_qty_value', 'lead_time', 'assign_bin_id', 'preferred_supplier_id',
                'brand_or_manufacturer_id', 'generic_name', 'generic_sku', 'purchasing_unit_id', 'purchasing_unit_cost',
                'avg_est_cost', 'new_product_flag', 'hide_on_website_or_guest_book', 'is_featured', 'web_user_name',
                'description_on_web', 'notes', 'special_intstruction', 'disclaimer', 'uom_one_id', 'uom_one_value',
                'uom_two_id', 'uom_two_value', 'uom_three_id', 'uom_three_value', 'uom_four_id', 'uom_four_value',
    ...
    public function show($id)
    {
        ...
        $unit_measure         = UnitMeasure::all();
        $product_price_range  = ProductPriceRange::all();
        return view('product.__show', compact('product', 'product_type', 'product_color', 'product_category', 'product_sub_category', 'country', 'product_group', 'product_thickness', 'product_finish', 'unit_measure', 'product_price_range'));
    }
    ...
    public function edit($id)
    {
        ...
        $unit_measure         = UnitMeasure::all();
        $product_price_range  = ProductPriceRange::all();
        return view('product.__edit', compact('product', 'product_type', 'product_color', 'product_category', 'product_sub_category', 'country', 'product_group', 'product_thickness', 'product_finish', 'unit_measure', 'product_price_range'));
