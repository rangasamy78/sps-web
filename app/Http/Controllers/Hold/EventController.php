...
use App\Repositories\Hold\EventRepository;
use App\Http\Requests\Hold\Event\CreateEventRequest;
...
class EventController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            if ($opportunityContact) {
                ...
                return response()->json(['status' => 'success', 'msg' => 'Hold Event deleted successfully.']);
            } else {
                return response()->json(['status' => 'false', 'msg' => 'Hold Event not found.']);
            }
        } catch (Exception $e) {
            Log::error('Error deleting Hold Event: ' . $e->getMessage());
            return response()->json(['status' => 'false', 'msg' => 'An error occurred while deleting the Hold Event.']);
        }
    }
    ...
    public function getHoldEventDataTableList(Request $request, $id)
    {
